...
\medskip
\begin{figure}[H]
  \center{\includegraphics[scale=0.215,cfbox=red] {images/metonic.png}}
...
\bigskip
\begin{figure} [H]
\center{\includegraphics[scale=0.40,frame] {images/general_gearing_plan.png}}
...
% \bigskip
\noindent
and we know that the driven gear rotates in the opposite
...
\bigskip
\begin{figure}[H]
\center{\includegraphics[scale=0.25,cfbox=red] {images/gearing_for_lunar_anomaly.png}}
