...
\centering
  \resizebox{0.90 \textwidth}{!} {															% resize figure if you want
   \begin{tikzpicture}[black!75,thick]
        ...
        \draw[ultra thick] (0.00,-1.00) -- (0.00,9.00);										% this is the support (y axis, I guess)
...
%
	     ...
	     \begin{footnotesize}
		   ...
		   \draw [draw=none] (12.00,0.10) -- (13.00,0.10) node[thin, draw,rectangle,midway] 
		   					 {${\; \mathbf {a = \ddot{x} = \dfrac{d^2 x}{dt^2} = -\dfrac{k}{m} x \;}}$};
		 \end{footnotesize}
