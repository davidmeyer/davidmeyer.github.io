...
\usetikzlibrary{calc,patterns,angles,quotes,shapes,math,decorations,through,lindenmayersystems}    
...
\pgfplotsset{every non boxed x axis/.append style={x axis line style=-latex}}
\pgfplotsset{every non boxed y axis/.append style={y axis line style=-latex}}
