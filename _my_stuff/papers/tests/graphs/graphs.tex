...
%
 ...
 %      \draw[draw=none] (0,0.15) -- (1.75,0.15) coordinate [label={[yshift=0.5cm] k}];		% draw k
 %      
 %
 %
 % draw the first mass
...
%
        ...
        \draw [draw=none] (0,2.750) -- (3.5,2.750) coordinate [label={[midway,below,yshift=-0.25cm] k}];		% draw k
