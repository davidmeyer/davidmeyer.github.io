...
\usetikzlibrary{calc,patterns,angles,quotes,shapes,calc,decorations,through,lindenmayersystems}    
...
\centering
  \resizebox{0.90 \textwidth}{!} {															% resize figure if you want
   \begin{tikzpicture}[black!75,thick]
        ...
        \draw[ultra thick] (0.00,-1.00) -- (0.00,8.00);										% draw vertical spring support
...
%
        ...
        \fill (0,0.40) circle(0.05);														% draw a dot connecting the spring to the vertical support
...
%        
 ...
 %  
      ...
      \path (c1) node[left] {\bf Hooke's Law Setup};
...
%
        \draw [
              decoration={
                 ...
                 pre length=3mm,
                 post length=3mm},
             decorate] (0,2.750) -- (3.5,2.750);
        \draw [draw=none] (0,2.750) -- (3.5,2.750) coordinate [label={[midway,above, yshift=0.25cm] \text{{\tiny {\bf Equilibrium State}}}}];  
        \fill (0,2.750) circle(0.05);											% draw a dot connecting the spring to the y axis
        \fill (3.5,2.750) circle(0.05);											% draw a dot connecting the spring to the mass
 ...
 %
       \node[draw,
	     ...
	     \begin{footnotesize}
		  ...
		  % \draw [draw=none] (12.00,2.50)  -- (13.00,2.50) coordinate [label={[midway] \underline{{\bf Newton's ${\mathbf 2^{\text{nd}}}$ Law = Hooke's Law}}}]; 

		   \draw [draw=none] (12.00,1.65)  -- (13.00,1.65) coordinate [label={[midway] {${\mathbf {\displaystyle ma = -kx \Rightarrow a = -\dfrac{k}{m} x}}$}}];
		   \draw [draw=none] (12.00,0.75)  -- (13.00,0.75) coordinate [label={[midway] \underline{{\bf Equation of Motion}}}]; 
		   \draw [draw=none] (12.00,0.00) -- (13.00,0.00) node[draw,rectangle,midway] {${\; \mathbf {a = \ddot{x} = \dfrac{d^2 x}{dt^2} = -\dfrac{k}{m} x \;}}$};
		 \end{footnotesize}
    \end{tikzpicture}
  }																				% end resizebox                                                                                           
\caption{Simple Spring and Mass System with Spring Constant $k$ and Mass $m$}
\label{fig:simple_spring_and_mass_system}
\end{figure}
