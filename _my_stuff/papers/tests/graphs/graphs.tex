...
%
        ...
        \fill (0,20.75) circle(0.05);																			% draw a dot connecting the spring to the y axis
        \fill (3.50,2.75) circle(0.05);																			% draw a dot connecting the spring to the mass
        \draw [draw=none] (0,2.75) -- (3.5,2.75) coordinate [label={[midway,below,yshift=-0.25cm] {\small k}}];	% draw k
