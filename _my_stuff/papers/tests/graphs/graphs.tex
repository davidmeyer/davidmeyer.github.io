...
%
      ...
      \coordinate (Gy) at (3.5,0.25,0);
      \coordinate (Gy1) at (3.5,-0.5,0);
%
% draw the curve in blue
%
      \draw[blue,thick] (A) to [bend right=50] (B);  
      \node[circle,draw=black, fill=red, scale=0.60] at (ball)  {};
     % \fill [red] (ball) circle (0.125);                                                                                                            % draw red ball on curve
      ...
      \draw[-stealth,thick] (Gy) -- (Gy1) coordinate [label={[font=\scriptsize, midway,right] $\vec{g}$}];   % draw y axis
      \draw[-stealth,very thin] (A) -- (Ay) coordinate [label={[font=\scriptsize, left] $y$}];
     \end{tikzpicture} }
    }                                                                                                                                                    % end \resizebox 
