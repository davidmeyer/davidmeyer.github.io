...
%	
		    ...
		    \draw[draw=none] (5,0.50) -- (10.50,0.75) node [midway,above,yshift=-1.0cm] {$d(\mathbf{x},\mathbf{y}) = \norm{\mathbf{x}-\mathbf{y}}$};
...
%  
			...
			\draw[draw=none] (10.50,0.50) -- (16.5,0.75) node [midway,above,yshift=-1.0cm] {${\boldsymbol \tau_d} = \{B_{d,\epsilon}(\mathbf{x})\}$};
		\end{tikzpicture}
		}
	}
