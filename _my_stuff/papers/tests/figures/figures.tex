...
\end{table}
 ...
 $\{1, \sqrt{2} \cos nt,\sqrt{2} \sin nt\}$, since $\langle 1,1 \rangle \neq \langle \cos nt, 
 \cos nt \rangle$ and $\langle 1,1 \rangle \neq \langle \sin nt,\sin nt \rangle$. Specifically, 
 $\langle 1,1 \rangle = 2$ (dividing out by $\pi$) whereas $\langle \cos nt, \cos nt \rangle = 
 \langle \sin nt, \sin nt \rangle = 1$ (again, dividing out by $\pi$).
