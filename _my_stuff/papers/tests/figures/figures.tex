 ...
 \resizebox{1.15 \textwidth}{!} {
   \begin{tabular}{|l|c|c|} 
     ...
     {\LARGE \bf Orthonormal Basis $\left (\mathbb{R}^3 \right )$} 
     									& $\{(1,0,0),(0,1,0),(0,0,1)\}$ 
										& $\{1, \cos nt, \sin mt\}, \, n,m \in \mathbb{N}\backslash\{0\}$ \\
	 [10pt]
     \hline
...
\end{table}
 ...
 {\setstretch{3.00}
 \noindent
 Note: Some people think that the orthonormal basis for the Fourier series should be
 $\{{\bf 1}, \sqrt{2} \cos nt,\sqrt{2} \sin nt\}$, since ${\displaystyle \langle {\bf 1},{\bf 1} \rangle 
 = \frac{1}{\pi}\int\limits_{-\pi}^{\pi} {\bf 1}^2 \, dt = \frac{1}{\pi}\int\limits_{-\pi}^{\pi} 
 dt = \frac{1}{\pi}  \, t \, \big |^{\pi}_{-\pi} = \frac{1}{\pi} \left (\pi - (-\pi) 
 \right ) = \frac{1}{\pi} 2\pi} = 2$. 
 OTOH, $\langle \cos nt, \cos nt \rangle = 
 {\displaystyle \dfrac{1}{\pi} \int\limits_{-\pi}^{\pi} \cos^2 nt \,dt = \dfrac{1}{\pi} 
 \pi = 1}$. 
 \par}
