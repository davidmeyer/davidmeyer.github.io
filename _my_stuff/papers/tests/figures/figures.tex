...
%	the \resizebox outside the \fcolorbox (either one). I like inside better because you
%	can control \fboxsep (roughly the amount of space inside the box), \fboxrule (the 
%	thickness of the frame around the box) and whatever is inside the box separately.
%		  
%
%
