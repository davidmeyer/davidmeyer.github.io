...
%
       \draw[thick,latex-latex](Xstart) -- (Xend) coordinate [label={[right] {\Huge ${\mathbf{u}}$}}];	% u axis
       \draw[thick,latex-latex](Ystart) -- (Yend) coordinate [label={[above] {\Huge ${\mathbf{v}}$}}];	% v axis
%
%	done
%       
   \end{tikzpicture}
...
%	draw axes
%
     \draw[thick,-latex] (O) -- (Xend) coordinate [label={[right] ${\mathbf{x}}$}];	% x axis
     \draw[thick,-latex] (O) -- (Yend) coordinate [label={[above] ${\mathbf{y}}$}];	% y axis
%
%	draw parallelogram
%
