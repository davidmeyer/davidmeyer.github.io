...
\begin{figure}[H]								% build the figure
  ...
  \fcolorbox{blue}{white} {					% make the outside frame black
		...
		\begin{tikzpicture}
			\draw (0,0) ellipse (1cm and 2cm) node [midway,below,yshift=-2.50cm] {$\text{\bf IPS $\{(X,\langle \cdot,\cdot \rangle)\}$}$};	
			\draw[fill=gray!15] (0,0) circle (0.50) node [] {\bf IPS};
    		\draw [->] (0,0.5) -- (5.0,0.75) node [midway,above,xshift=-0.50,yshift=0.75cm] {$\color{red}{\text{\bf Induced norm}}$};
		    \draw [draw=none] (0,0.5) -- (5.0,0.75) node [midway,above,xshift=-0.750,yshift=-3.750cm] {$\boldsymbol{\subseteq}$};
    		\draw [->] (0,-0.5) -- (5.0,-0.75);
    		\draw[draw=none] (3.5,0.50) -- (1.5,0.75) node [midway,above,yshift=-1.0cm] {$\norm{x} = \sqrt{\langle x,x\rangle}$};
    		\draw (5,0.0) ellipse (1cm and 2cm) node [midway,below,xshift=5.0cm,yshift=-2.50cm]{$\text{\bf NVS $\{(X,\norm{\cdot})\}$}$};	
    		\draw[fill=gray!15] (5.0,0) circle (0.750) node [] {\bf NVS};   
    		\draw (10.50,0.0) ellipse (1cm and 2cm) node [midway,below,xshift=10.50cm,yshift=-2.5cm]{$\text{\bf MS $\{(X,d(\cdot,\cdot))\}$}$};	
    		\draw [->] (5,0.75) -- (10.50,0.75) node [midway,above,xshift=-0.75,yshift=0.60cm] {$\color{red}{\text{\bf Induced metric}}$};
		    \draw [draw=none] (5,0.5) -- (10.0,0.75) node [midway,above,xshift=-0.50,yshift=-3.750cm] {$\boldsymbol{\subseteq}$};
    		\draw [->] (5,-0.75) -- (10.50,-0.75);
    		\draw[fill=gray!15] (10.50,0) circle (0.750) node [] {\bf MS};   
    		\draw[draw=none] (5,0.50) -- (10.50,0.75) node [midway,above,yshift=-1.0cm] {$d(x,y) = \norm{\mathbf{x}-\mathbf{y}}$};
			\draw (16.5,0.0) ellipse (1cm and 2cm) node [midway,below,xshift=16.5cm,yshift=-2.5cm]{$\text{\bf TS $\{(X,{\boldsymbol \tau_{d}})\}$}$};	
			\draw [->] (10.50,0.75) -- (16.5,0.75) node [midway,above,yshift=0.50cm] {$\color{red}{\text{\bf Induced topology}}$};
			\draw [draw=none] (10,0.5) -- (16.5,0.75) node [midway,above,xshift=0.50cm,yshift=-3.750cm] {$\boldsymbol{\subseteq}$};
			\draw [->] (5,-0.75) -- (16.5,-0.75);
			\draw[fill=gray!15] (16.5,0) circle (0.750) node [] {\bf TS};   
			\draw[draw=none] (10.50,0.50) -- (16.5,0.75) node [midway,above,yshift=-1.0cm] {${\boldsymbol \tau_d} = \{B_{d,\epsilon}(x)\}$};
		\end{tikzpicture}
		}
	}
...
\begin{figure}[H]								% build the figure
  \centering									% center everything
  \fcolorbox{black}{gray!10} {					% make the outside frame black
	 \resizebox{1.00\textwidth}{!} {
	    \begin{math}
          \begin{array}{llllll}
            ...
            && {\bf TS}  &--& \text{Topological Spaces}	  & (X, {\boldsymbol \tau_d)} = (X,\{B_{d,\epsilon}({\bf u})\}), 
                                                \; \forall \epsilon > 0 \land \forall {\bf u} \in U \land U \subseteq X \land \text{ $U$ open in $X$}
          \end{array}
        \end{math}
     }
  }
