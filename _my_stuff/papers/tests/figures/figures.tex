...
\begin{figure}[H]
  ...
  \fcolorbox{black}{white}{
    \resizebox{0.750 \textwidth}{!} {                      % resize figure here if you want
      \begin{math}
        G (\mathbat) \xrightswishingghost{n = \langle \bigskull, \mathghost \rangle} 
        \! \bigpumpkin_{t=1}^{n} S_{t}(\mathwitch){ }
      \end{math}
     }
  }
