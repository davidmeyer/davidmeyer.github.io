...
\setlength {\fboxrule}{1.25pt}					% change the fcolorbox line thickness
%												%
%												%
%												%
\begin{figure}[H]								% build the figure
  \centering									% center everything
  \fcolorbox{orange}{white}{					% make the frame orange					
    \resizebox{0.750 \textwidth}{!} {			% resize the figure if you like
