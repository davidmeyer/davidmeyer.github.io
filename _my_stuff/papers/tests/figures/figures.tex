...
\end{table}
 ...
 = \frac{1}{\pi}\int\limits_{-\pi}^{\pi} 1^2 \, dt = \frac{1}{\pi}  \, t \, \big |^{\pi}_{-\pi}= 
 \frac{1}{\pi} \left (\pi - (-\pi) \right ) = \frac{1}{\pi} 2\pi} = 2$. OTOH, 
 $\langle \cos nt, \cos nt \rangle = {\displaystyle \dfrac{1}{\pi} \int\limits_{-\pi}^{\pi} 
 \cos^2 nt \,dt = \dfrac{1}{\pi} \pi = 1}$. 
