...
%
%
\def \nrows{7}																			% number of rows in the triangle
...
\begin{verbatim}
From @psu_13@mathstodon.xyz: @dmm you are probably overflowing LaTeX's 
poor macro engine...which was never built to do this kind of heavy lifting.
