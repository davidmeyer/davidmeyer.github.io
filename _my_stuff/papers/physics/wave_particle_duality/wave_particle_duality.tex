...
\cite{wiki:matter_wave,wiki:wave_particle_duality} and so Equation
...
h \dfrac{c}{\lambda}
&=& mc^2	
			&\hspace{8em} \mathrel{\#} \text{de Broglie's insight: 
				$E_{\text{{\tiny P}}} = E_{\text{{\tiny E}}}$} \\
[10pt]
&\Rightarrow& \dfrac{h}{\lambda} = mc
			&\hspace{8em} \mathrel{\#} \text{cancel $c$} \\
[10pt]
&\Rightarrow& \dfrac{h}{\lambda} = m \mathbf{v}
			&\hspace{8em} \mathrel{\#} \text{$\mathbf{v} := c$ ($c$ not a vector?)} \\
[10pt]
&\Rightarrow& \lambda = \dfrac{h}{m \mathbf{v}}
			&\hspace{8em} \mathrel{\#} \text{solve for $\lambda$}\\
[10pt]
&\Rightarrow& \lambda = \dfrac{h}{\mathbf{p}}
			&\hspace{8em} \mathrel{\#} \text{$\mathbf{p} = m \mathbf{v}$ ($\lambda$ not a vector?)} \\
[10pt] 
\end{array}
\end{equation*}
%
