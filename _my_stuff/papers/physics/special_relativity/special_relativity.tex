...
\bigskip
\noindent
In general, the coordinates in the "stationary" frame of
reference are denoted $(t,x,y,z)$, while the coordinates 
in the "moving" frame of reference are denoted $(t^{\prime},
x^{\prime},y^{\prime},z^{\prime})$ (of course, stationary 
and moving are relative terms...) \cite{einstein1905}.


\bigskip
\noindent
The $h$, $x^{\prime}$, $c t^{\prime}$ triangle is abstracted in 
...
sometimes written $\gamma(v)$ to emphasize $v$.
%
%
%
...
\label{section:the_lorentz_transformation}
%
%
%
\section{Conclusions}
