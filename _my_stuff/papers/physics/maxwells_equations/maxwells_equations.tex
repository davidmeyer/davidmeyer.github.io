...
\bigskip
\noindent
Next, notice that the speed of light is related to the
$\epsilon_0$ and $\mu_0$ by the equation 
...
\times 10^{-12} \; F/m$.  Note that $\epsilon_0$ has a relative
uncertainty of $1.5 \times 10^{-10}$.
...
the dot notation for the divergence represents a sort of a
"psuedo dot product", since the divergence doesn't commute
(whereas the standard dot product does commute)
