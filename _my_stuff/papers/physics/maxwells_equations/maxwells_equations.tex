...
\date{Last Update: \today \\
	 {\vspace{1.00mm} \small Initial Version: September 19, 2023}}
%
% \date{Last update: \today}
%
%
...
can not exist \cite{gauss_law_for_magnetic_fields}.
...
a magnetic field ($\vB$) \cite{amperes_law}. Maxwell's addition 
to Ampere's law is the term $\mu_0 \epsilon_0 \dfrac{\partial 
