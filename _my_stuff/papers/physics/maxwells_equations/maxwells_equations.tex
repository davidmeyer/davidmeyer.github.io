...
\begin{table} [H]
  ...
  \resizebox{0.75 \textwidth}{!} {                                                              % resize figure if you want
     \begin{tabular} {| c | c  | c | c |}
      ...
      \hline
      $\vJ$        & Current density            & A/$\text{m}^2$        & Ampere/$\text{m}^2$ \\
      \hline
      $\rho$       & Charge density             & C/$\text{m}^3$        & Coulomb/$\text{m}^3$ \\
      \hline
      $c$          & Speed of light in a vacuum & m/s                   & $c = 2.99792458 \times 10^{8} \; \text{m/s}$ \\
      \hline
      $\mu_0$      & Permeability of free space & H/m                   & $\mu_0 = 4\pi \times 10^{-7} \; \text{H/m}$ \\
      \hline
...
\bigskip
\noindent
Note that 1 Henry/m $= 1$ Newton/$\text{Ampere}^2$. 
...
where $1 \; \text{Henry/m} = 1 \; \text{Newton}/\text{Ampere}^2
\Rightarrow 4\pi \times 10^{-7} \; \text{H}/\text{m} =
1.25663706143 \hdots \times 10^{-6} \; \text{N}/\text{A}^2$.  So
$\mu_0$ is given. We also know that the speed of light $c$ is
equal to $2.99792458 \times 10^{8} \; \text{m/s}$. So we can
consider $c$ as given.

\bigskip
\noindent
Next, notice $\epsilon_0$ and $\mu_0$ are not independent but
rather are related by the speed of light
\cite{wikipedia:maxwells_equations}:
...
\bigskip
\item Faraday's law of electromagnetic induction \cite{faradays_law}
...
\bigskip
\item  Ampere's law	with Maxwell's addition \cite{amperes_law}
...
\bigskip
\item  Ampere's law with Maxwell's addition
...
19th century \cite{wikipedia:maxwells_equations}.
