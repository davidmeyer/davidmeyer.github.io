...
%
%
\section{Oliver Heaviside's Contributions}
...
and systems. It's also known as the Heaviside calculus in honor
of his pioneering work in this area.
...
notion of differential operators, such as the D-operator (d/dt),
which allowed him to manipulate differential equations more
effectively \cite{wikipedia:differential_operator}.
...
circuits. The Heaviside step function is shown in 
Definition \ref{def:heaviside_function} and Figures 
\ref{fig:u(t)}, \ref{fig:u(t-a)} and \ref{fig:u(a-t)}.
...
written as $u_a(t)$ and is shown in Figure \ref{fig:u(t-a)}.
...
\bigskip
\noindent
Another useful version of the Heaviside step function is 
shown in Figure \ref{fig:u(a-t)}.
