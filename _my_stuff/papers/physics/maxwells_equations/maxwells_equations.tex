...
\bigskip
\noindent
Interestingly, it turns out that the speed of light, $c$,
can be calculated from $\mu_0$ and $\epsilon_0$ as follows
...
the divergence, while $\nabla \times \mathbf{F}$ is the cross
product. It is worth noting here that using the dot notation 
for the divergence represents a sort of a "psuedo dot product", 
since the divergence doesn't commute (whereas the standard dot 
product does commute) \cite{dmm:vector_calculus,the_role_of_grad}.
More specifically
