...
1.25663706143 \hdots \times 10^{-6} \; \text{N}/\text{A}^2$ (see 
Table \ref{tab:definitions}).  So $\mu_0$ is given. We also know 
that the speed of light $c$ is equal to $2.99792458 \times 10^{8} 
\; \text{m/s}$. So we can consider $c$ as given.
...
Thanks to Larry Lang for suggesting that I should add some 
text about Oliver Heaviside's important contributions to 
Maxwell's equations (see Section \ref{sec:heaviside_contribution}).
%
