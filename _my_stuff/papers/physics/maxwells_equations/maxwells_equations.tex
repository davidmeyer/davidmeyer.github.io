...
electromagnetic wave \cite{wikipedia:speed_of_light}.  The 
classical behavior of the electromagnetic field is described 
by Maxwell's equations, which predict that the speed at which 
electromagnetic waves (e.g. light) propagate in vacuum is related 
to the distributed capacitance and inductance of vacuum, aka the 
permittivity $\epsilon_0$ and the permeability $\mu_0$. Interestingly, 
this means that the speed of an electromagnetic wave in a vacuum 
can be directly calculated from $\epsilon_0$ and $\mu_0$ as follows:
