...
&=& -\dfrac{\partial \vB}{\partial t} 	&
			\hspace{6em} \mathrel{\#} \text{moving a magnetic 
...
%
 ...
 %
			...
			\node[below right] at (\xOffset,-0.5*\yOffset,4*\zOffset)
				{$\vE\cdot\vk = 0,\;\; \vB\cdot\vk = 0,\;\; 
					\vB = \frac{1}{c_0}\vk\times\vE$};
 %
 %	Now draw the waves
 %
...
\caption{Propagation of an electromagnetic wave in the $\vk$ direction}
\end{figure}
%
%
%
