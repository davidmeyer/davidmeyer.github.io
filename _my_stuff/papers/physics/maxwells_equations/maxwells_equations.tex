...
\begin{table} [H]
  ...
  \resizebox{0.75 \textwidth}{!} {                                                              % resize figure if you want
     \begin{tabular} {| c | c  | c | c |}
      ...
      \hline
      $c_0$        & Speed of light in a vacuum & m/s                   & Meter/Second \\
      \hline
    \end{tabular}
   }                                                                                            % end resizebox
...
predict that the speed at which electromagnetic waves (such as
light) propagate in vacuum is related to the distributed
capacitance and inductance of vacuum, otherwise known as the
electric constant $\epsilon_0$ and the magnetic constant $\mu_0$
respectively. Interestingly, as a result the speed of an
electromagnetic wave (e.g. light) in a vacuum can be calculated
directly from $\epsilon_0$ and $\mu_0$ as follows
\cite{wikipedia:speed_of_light}


\begin{equation*}
c_0 = \dfrac{1}{\sqrt{\epsilon_0 \mu_0}}
\end{equation*}
