...
product \cite{dmm:vector_calculus,the_role_of_grad}. It is worth
noting here that using the dot notation for the divergence represents
a sort of a "psuedo dot product", since the divergence doesn't
commute (whereas the standard dot product does commute).
...
$y$, and $z$ directions respectively. Note that $\vi$, $\vj$, and
$\vk$ are the canonical basis vectors for $\mathbb{R}^3$
