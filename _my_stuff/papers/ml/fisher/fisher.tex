...
&=& {\displaystyle \int \nabla_\theta p_\theta(x) dx} 
		&\mathrel{\#} \frac{p_\theta(x)}{p_\theta(x)} = 1 \\ 
[10pt]
&=& \nabla_\theta \int p_\theta(x) dx 
		& \mathrel{\#} \text{exchange $\int$ and $\nabla$ can be exchanged} \\ 
[10pt]
&=& \nabla_{\theta} 1 
		&\mathrel{\#} \text{$p_\theta(x)$ is a density so} \int_x p_\theta(x) dx = 1 \\ 
[10pt]
&=& 0 
		&\mathrel{\#} \text{for c any constant}
\nabla c = 0
\end{array}
\end{equation*}
