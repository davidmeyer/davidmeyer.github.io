...
$\mathbb{E}_{\theta}\big[\nabla_{\theta} \log p_{\theta}(X)\big]
= \mathbb{E}_{\theta} \big[l_{\theta} \big ] = 0$. This condition 
(expected value of the score function is zero) is called a
\emph{regularity condition} and is required by the Cram\'er Rao
