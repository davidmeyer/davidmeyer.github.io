...
&=& {\displaystyle \int_{x} p_{\theta}(x) \, \nabla_{\theta} \log p_{\theta}(x) \; dx}
		&\qquad \qquad \mathrel{\#} \text{definition of expectation with $x \sim p(x;\theta)$} \\ 
[12pt]
&=& {\displaystyle \int_{x} \frac{\nabla_\theta p_\theta(x)}{p_\theta(x)} \, p_\theta(x) \; dx} 
		&\qquad \qquad \mathrel{\#} \text{log derivative trick \cite{log_derivative_trick}: } 
									\nabla_{\theta} \log p_{\theta}(x) = 
		                            \dfrac{\nabla_{\theta} p_\theta(x)}{p_\theta(x)} \\ 
[12pt]
&=& {\displaystyle \int_{x} \nabla_\theta p_\theta(x) \; dx} 
		&\qquad \qquad \mathrel{\#} \text{cancel $p_\theta(x)$}\\ 
[12pt]
&=& {\displaystyle \nabla_\theta \int_{x} p_\theta(x) \; dx} 
		&\qquad \qquad \mathrel{\#} \text{exchange ${\displaystyle \int}$ and $\nabla$} \\ 
[12pt]
&=& \nabla_{\theta} 1 
...
&=& -\nabla_{\theta}^{2} \log p_\theta(x) + \dfrac{\nabla_{\theta}^{2} p_\theta(x)}{p_\theta(x)}
		&\qquad \mathrel{\#} l_\theta l_{\theta}^{\small{T}} = 
		              -\nabla_{\theta}^{2} \log p_\theta(x) + 
		              \dfrac{\nabla_{\theta}^{2} p_\theta(x)}{p_\theta(x)}
\end{array}
\end{equation*}
