...
the ratio of the progression is $\sqrt{\phi}$, the square root 
of the golden ratio $\phi$
\cite{wiki:golden_ratio}. The Kepler triangle
...
\bigskip
\noindent
More generally, if the ratio of the geometric progression 
of the sides of the triangle is
$\sqrt{x}$ then the sides of the triangle are in the ratio 
$1 : \sqrt{x} : x$. From this we know (by the Pythagorean theorem
...
of the golden ratio $\phi$, so we know that $x = \phi$.
