...
unit length vector in $H_2$. If a state is equal to a basis
vector then we say it is a \emph{pure} state. If a state is any
other linear combination of the basis vectors we say it is a
\emph{mixed} state, or that the state is a superposition of
$\ket{0}$ and $\ket{1}$.
