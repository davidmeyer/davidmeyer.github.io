...
&\Rightarrow& \mathcal{L}\{y^{\prime \prime} - y^\prime -2y\} = \mathcal{L}\{0\} 
		&\mathrel{\#} \text{take the LT of both sides} \\
[15pt]
 &\Rightarrow& \mathcal{L}\{y^{\prime \prime}\} - \mathcal{L}\{y^\prime\} -\mathcal{L}\{2y\}  = \mathcal{L}\{0\}      &\mathrel{\#} \text{$\mathcal{L}$ is a linear operator (Section \ref{subsec:linearity})}                                                                                     \\
[15pt]
