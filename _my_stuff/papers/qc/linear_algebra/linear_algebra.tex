...
everywhere else\footnote{The canonical unit vectors look surprisingly 
like the one-hot encoding used in machine learning \cite{wiki:one-hot}.}.
The set $B$ forms a basis, sometimes called the canonical basis, 
for the vector space $\mathbb{R}^{n}$.
