...
subspace of $\mathbb{R}^{2}$. This is shown (hopefully) in Figure 
...
%
%		Still looking for a reasonable way to get x and y out of a coordinate 
%		(then I would only need to specify EP). Anyway...
%
...
%		All of this implies that m = y/x = 5/8. 
%
%		So coordinates on the line U are of the form (x,(5/8)*x).
%
...
%
       ...
       \draw[very thick,magenta] (SP)     -- (EP)   node [right,xshift=1.50mm,yshift=1.50mm] 
