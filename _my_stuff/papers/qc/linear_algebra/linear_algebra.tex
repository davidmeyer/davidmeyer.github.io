...
\smallskip
\noindent
Consider a matrix $\bm{A} \in \mathbb{R}^{2}$ with $\bm{A} = 
	\left (
		\hspace{-0.50em}
		\begin{array}{cccc}
			\vertbar & \vertbar \\
...
$\bm{y} = \left ( 
					...
					\hspace{-0.50em}
					\right )$.
Then $\bm{A}(\mathbf{x}+\mathbf{y})$ is
...
&=&
	...
	\Bigg (
		...
		\end{array}
		\hspace{-0.50em}
	\Bigg ) 												&\hspace{1.25em}\mathrel{\#} \text{vector addition in $\mathbb{R}^{2}$} \\
[25pt]
&=&
	\left (
		\hspace{-0.50em}
	...
	\Big ( 
		...
		\end{array}
		\hspace{-0.50em}
	\Big ) 														&\hspace{1.25em}\mathrel{\#} \text{definition of matrix product (mp)} \\
[25pt]
&=&
	\left (
		\hspace{-0.50em}
...
\left (
	...
	\left (
		...
		\hspace{-0.50em}
	\right )
	y_2 														&\hspace{1.25em}\mathrel{\#} \text{mp distributes over addition} \\
[25pt]
&=&
	\left (
		\hspace{-0.50em}
...
\left (
	...
	\left (
		...
		\hspace{-0.50em}
	\right )
	y_2																&\hspace{1.25em}\mathrel{\#} \text{rearrange} \\
[25pt]
&=&
\left (
		\hspace{-0.50em}
	...
	\hspace{-0.25em}
		\Bigg (
			...
			\end{array}
			\hspace{-0.50em}
		\Bigg )										&\hspace{1.25em}\mathrel{\#} \text{definition of the matrix product} \\
[25pt]
&=&
\left (
		\hspace{-0.50em}
	...
	\right )
		...
		\hspace{-0.50em}
	\right )
		\bm{y}													&\hspace{1.25em}\mathrel{\#}\bm{x} = \Bigg (
																							\hspace{-0.50em}
																							\begin{array}{cccc}
																								x_1 \\
																								x_2
...
[25pt]
&=&
\bm{A}\mathbf{x} + \bm{A}\mathbf{y}									&\hspace{1.25em}\mathrel{\#} \bm{A} = \left (
																							\hspace{-0.50em}
																							\begin{array}{cccc}
																								\vertbar & \vertbar \\
																								a_{1}    & a_{2}    \\
...
[25pt]
&\Rightarrow&
\bm{A}(\mathbf{x}+\mathbf{y}) = \bm{A}\mathbf{x}+ \bm{A}\mathbf{y}		&\hspace{1.25em}\mathrel{\#} \text{condition \ref{enumerate:distributive} above}
