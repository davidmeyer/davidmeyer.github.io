...
\left ( \hspace{-0.35em} \begin{array}{cccc} x_1, x_2,\hdots, 
x_n \end{array} \hspace{-0.35em} \right)$ be a vector in 
$\mathbb{R}^{n}$. Then define the canonical basis vectors in 
$\mathbb{R}^{n}$ as follows:

\begin{definition}
\label{def:canonical_basis_vectors}
{\bf Canonical Basis Vectors: } The canonical basis vectors in 
