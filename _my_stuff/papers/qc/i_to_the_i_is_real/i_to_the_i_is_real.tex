...
any choice of an integer $k$ in $re^{i\theta+2\pi ki}$ is a valid
inverse for the complex exponential. The logarithm is therefore a
multivalued function and each value of $k$ defines what we call a
different \emph{branch} of the logarithm. The principal branch
