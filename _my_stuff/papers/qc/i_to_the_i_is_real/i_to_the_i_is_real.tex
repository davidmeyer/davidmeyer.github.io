...
There are a few ways to think about this question. In Section
\ref{sec:automorphism} we use the fact that complex conjugation
is an automorphism of $\mathbb{C}$. In Section
...
\cite{wiki:principle_branch} usually corresponds to the choice
$k=0$.
%
%
%
...
\begin{figure}[H]
\centering
  \resizebox{0.385 \textwidth}{!} {                                                             % resize figure if you want
...
\smallskip
\noindent
Figures \ref{fig:complex_plane} and \ref{fig:eulers_formula} make it easy to see 
why $z = r \mathrm{e}^{i\theta}$. Specifically
\begin{equation*}
\begin{array}{lllll}
z
&=& a + ib
...
\begin{array}{llll}
\overline{i^i}
&=& {\overline{i}}^{\overline{i}}       &\hspace{7em} \mathrel{\#} \text{see proof below} \\
[2pt]
...
[5pt]
&=& \log(r) + \log(e^{-i\theta})	
		&\hspace{7em} \mathrel{\#} \text{product rule for logarithms \cite{properties_of_logarithms}} \\
[5pt]
&=& \log(r) - \log(e^{i\theta})
		&\hspace{7em} \mathrel{\#} \text{since $\log(a^{-b}) = -\log(a^b)$}
\end{array}
\end{equation*}
...
&=& \overline{\log(r)} + \overline{\log(e^{i\theta})}
                &\hspace{7em} \mathrel{\#} \text{by sum rule for conjugates \cite{sum_of_conjugates}} \\
[5pt]
...
\begin{array}{llll}
\log(\overline{z^w})
&=& \overline{\log(z^w)}                        &\hspace{7em} \mathrel{\#} \text{by Equation (\ref{eqn:log_of_conjugate})} \\
[5pt]
&=& \overline{w\log(z)}                         &\hspace{7em} \mathrel{\#} \text{by the power rule for logarithms} \\
[5pt]
&=& \overline{w} \cdot \overline{\log(z)}       &\hspace{7em} \mathrel{\#} \text{by the product rule for conjugation} \\
[5pt]
&=& \overline{w} \cdot \log(\overline{z})	&\hspace{7em} \mathrel{\#} \text{by Equation (\ref{eqn:log_of_conjugate})} \\
[5pt]
&=& \log(\overline{z}^{\overline{w}})           &\hspace{7em} \mathrel{\#} \text{by the power rule for logarithms}
\end{array}
\end{equation*}
