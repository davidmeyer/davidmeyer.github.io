...
\begin{itemize}
\item It would be helpful to have a proof that complex conjugation distributes over
complex exponentiation. That is, a proof that $\overline{i^i} = {\overline{i}}^{\overline{i}}$.

\smallskip

One argument is that since $\overline{i^i} \in \mathbb{R}$ (as shown above) and the complex
conjugate of a real number, it must be that $\overline{i^i} = i^i$. But AFAICU this doesn't
show that $\overline{i^i} = {\overline{i}}^{\overline{i}}$.
\end{itemize}
%
%
%
