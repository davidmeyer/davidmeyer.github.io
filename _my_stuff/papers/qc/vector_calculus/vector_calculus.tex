...
\bigskip
\noindent
To prove the Cauchy–Schwarz inequality we need the reverse triangle inequality:
...
&\Rightarrow& 1 \geq \langle \mathbf{x},\mathbf{y} \rangle 
					&\quad \mathrel{\#} \text{divide by -2 $\Rightarrow$ reverse inequality}  \\
[12pt]
...
&\Rightarrow& \left \langle \dfrac{\mathbf{a}}{\| \mathbf{a} \|}, 
					...
					&\quad \mathrel{\#} \text{by definition above: }
					\mathbf{x} = \dfrac{\mathbf{a}}{\| \mathbf{a} \|}, \; \mathbf{y} 
