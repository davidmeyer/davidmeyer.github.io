...
&=& \langle \mathbf{b}, \mathbf{a} \rangle
					&\hspace{3em} \mathrel{\#} \text{Equation (\ref{eqn:dot_product}) and 
					$\sum\limits_{j = 1}^{n} a_j b_j = \sum\limits_{j = 1}^{n} b_j a_j$
					for scalars $a_j$ and $b_j$} \\
[15pt]
&=& \langle \mathbf{b}, (\alpha \mathbf{v}_1 + \beta \mathbf{v}_2) \rangle
					&\hspace{3em} \mathrel{\#} \text{Equation (\ref{eqn:alpha_beta})} \\
[15pt]
...
&=& \alpha \| \mathbf{b} \| \langle \mathbf{v}_1, \mathbf{v}_1 \rangle
					&\hspace{3em} \mathrel{\#} \text{by the scalar product rule for dot products } \\
[15pt]
&=& \alpha \| \mathbf{b} \|
