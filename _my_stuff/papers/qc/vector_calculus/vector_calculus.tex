...
This setup is shown in Figure \ref{fig:geometric_dot_product}.
%
...
\mathbf{T}
&=& \dfrac{\dot{\mathbf{r}}} {\norm{\dot{\mathbf{r}}}} 
			&\hspace{6em} \mathrel{\#} \text{the unit vector in the $\mathbf{u}$ 
			direction (usually denoted $\hat{\mathbf{u}}$) equals
			$\dfrac{\mathbf{u}}{\norm{\mathbf{u}}}$} \\
[15 pt]
&=& \dfrac{\left (\dfrac{d\mathbf{r}}{dt}\right )}{\norm{\dot{\mathbf{r}}}} 
			&\hspace{6em} \mathrel{\#} \dot{\mathbf{r}} = \dfrac{d\mathbf{r}}{dt}
...
[25 pt]
&=& \dfrac{d\mathbf{r}}{ds}
			&\hspace{6em} \mathrel{\#} \text{simplify}
\end{array}
\end{equation*}
