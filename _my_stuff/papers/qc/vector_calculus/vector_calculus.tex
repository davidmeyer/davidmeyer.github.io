...
is precisely $\alpha \mathbf{v}_1$. To determine $\alpha$ we  
take the inner product with $\mathbf{b}$ in the above identity
as follows:
...
("in the direction of") the vector $\mathbf{b}$.
\end{definition}


\bigskip
\begin{definition}
{bf The Cross Product of Two Vectors:}
\end{definition}
