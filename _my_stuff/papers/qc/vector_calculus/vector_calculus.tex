...
&=& \sum\limits_{j = 1}^{n} (x_j - y_j)^2
		&\hspace{2em} \mathrel{\#} \text{$\langle \mathbf{x},\mathbf{y} \rangle  = \sum\limits_{j = 
					1}^{n} x_{j} y_{j}$ (Equation (\ref{eqn:magnitude}))}\\
[12pt]
...
&=& \sum\limits_{j = 1}^{n} x_j ^2 - 2 \sum\limits_{j = 1}^{n} x_j y_j + \sum\limits_{j = 1}^{n} y_j
		&\hspace{2em} \mathrel{\#} \text{sum is a linear operator} \\
[10pt]
&=&  \| \mathbf{x} \|^2 - 2  \langle \mathbf{x} , \mathbf{y} \rangle + \| \mathbf{y} \|^2 
 		&\hspace{2em} \mathrel{\#} \text{${\| \mathbf{x} \|}^2 = \sum\limits_{j = 1}^{n} {x_{j}}^2$ 
					and $\langle \mathbf{x},\mathbf{y} \rangle  = \sum\limits_{j = 
