...
\bigskip
\noindent
First, to prove the Cauchy–Schwarz inequality we need
the (reverse) triangle inequality 
\cite{vector_norms_and_matrix_norms,wiki:triangle_inequality}:
...
&=& \| \mathbf{x} + (-\mathbf{y} + \mathbf{y})\| 
					&\quad \mathrel{\#} \mathbf{x} =  \mathbf{x} + 0 
					= \mathbf{x} + (-\mathbf{y} + \mathbf{y}) \\
[8pt]
&=& \| (\mathbf{x} - \mathbf{y} ) + \mathbf{y} \|
					&\quad \mathrel{\#} \text{addition is associative: $a + (b + c) = (a + b) + c$} \\
[8pt]
...
&=& \| \mathbf{y} + (-\mathbf{x} + \mathbf{x})\|
					&\quad \mathrel{\#} \mathbf{y} = \mathbf{y} + 0
					= \mathbf{y} + (-\mathbf{x} + \mathbf{x}) \\
[8pt]
&=& \| (\mathbf{y} - \mathbf{x}) + \mathbf{x} \|
					&\quad \mathrel{\#} \text{addition is associative: $a + (b + c) = (a + b) + c$} \\
...
&\Rightarrow& - \Big [ \| \mathbf{y} \| - \| \mathbf{x} \| \Big ]\geq -\| \mathbf{y} - \mathbf{x}\|
					&\quad \mathrel{\#} \text{divide both sides by -1: $X \leq Y \Rightarrow -X \geq -Y$} \\
[8pt]
...
&\Rightarrow& 1 \geq \langle \mathbf{x},\mathbf{y} \rangle 
					&\quad \mathrel{\#} \text{divide by -2, flip inequality}  \\
[12pt]
