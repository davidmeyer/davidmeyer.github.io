...
&=& \sqrt{dg^2 + dh^2} \cdot \Bigg [\sqrt{\dfrac{1}{dt^2}} \cdot dt \Bigg ]
			&\qquad \qquad \mathrel{\#} \dfrac{x}{x} = \sqrt{\left (\dfrac{1}{x} \right)^2} \cdot x = \sqrt{\dfrac{1}{x^2}} \cdot x, \; x > 0  \\
[15pt]
&=& \sqrt{\left (\dfrac{1}{dt^2} \right) \cdot \Big ( dg^2 + dh^2 \Big )} \cdot dt
			&\qquad \qquad \mathrel{\#} \sqrt{\dfrac{1}{x}} \cdot \sqrt{y} = \sqrt{\dfrac{1}{x} \cdot y} \\
[15pt]
