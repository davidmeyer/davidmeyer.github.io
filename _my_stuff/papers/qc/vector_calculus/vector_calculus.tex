...
\bigskip
\begin{itemize}
\item [] (A) $(\mathbb{K},+)$ is an abelian group\footnote{See Appendix A and B for more on
             fields and abelian groups.} with identity element $0$ (called zero).
\item [] (M) $(\mathbb{K} \backslash \{0\}, \cdot)$ is an abelian group with identity element 1.
...
\bigskip
\begin{figure}[H]
\center{\includegraphics[cfbox=black,scale=0.305] 
