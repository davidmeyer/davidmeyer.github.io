...
&=& \langle \mathbf{b}, \alpha \mathbf{v}_1 \rangle + \langle \mathbf{b}, \beta \mathbf{v}_2 \rangle
					&\qquad \mathrel{\#} \text{dot product is distributive over vector addition} \\
[10pt]
&=& \alpha \langle \mathbf{b},\mathbf{v}_1 \rangle + \beta  \langle \mathbf{b}, \mathbf{v}_2 \rangle
					&\qquad \mathrel{\#} \text{by the scalar multiplication rule:
...
it if the scalar is less than zero), we see that 
$\langle \mathbf{a}, \mathbf{b} \rangle$ is also 
the component of $\mathbf{a}$ in the $\mathbf{b}$
direction.
