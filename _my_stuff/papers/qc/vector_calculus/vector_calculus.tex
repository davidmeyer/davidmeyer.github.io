...
\bigskip
\begin{definition}
{\bf Dot Product: } The dot product (or scalar product or 
inner product) of two column vectors $\mathbf{a} 
= (a_1,a_2,\hdots, a_n)^{\intercal}$ and 
$\mathbf{b} = (b_1,b_2,\hdots, b_n)^{\intercal}$,
