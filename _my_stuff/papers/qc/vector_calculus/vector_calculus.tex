...
are $a = 0$ and $b = \frac{\pi}{2}$. Putting this all together we get
...
\bigskip
\noindent
Ok, but what is $ds$? As we saw in Figure \ref{fig:pythagorean_theorem}
the Pythagorean theorem tells us that $ds = \sqrt{dx^2 + dy^2}$. Using
this expression for $ds$ we can see that
...
\bigskip
\noindent
So we can rewrite our line integral in terms of a single variable $t$ as follows:
