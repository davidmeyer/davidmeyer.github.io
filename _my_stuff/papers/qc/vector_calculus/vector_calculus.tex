...
\subsection{Vectors}
In this section we'll define vector notation and a few important vector
operations.
...
\bigskip
\noindent
In these notes we will use $\mathbf{a} = [a_1,a_2,\hdots, a_n]$ 
...
\smallskip
\begin{definition}
{\bf Dot Product:} $\mathbf{a} \cdot \mathbf{b} \equiv 
...
or $\langle \mathbf{a}, \mathbf{b} \rangle$,
...
are scalars and scalar multiplication is commutative) 
we have
