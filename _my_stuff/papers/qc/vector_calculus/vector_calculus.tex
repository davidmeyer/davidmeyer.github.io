...
\bigskip
\noindent
Another common notation for the dot product
$\mathbf{a} \cdot \mathbf{b}$ is $\langle \mathbf{a},
\mathbf{b} \rangle$.
...
\rightarrow \underbrace{\begin{bmatrix} a_1, a_2, \hdots, a_n \end{bmatrix}}_{1 \times n} 
\underbrace{\begin{bmatrix} b_1 \\ b_2 \\ \vdots \\ b_n \end{bmatrix}}_{n \times 1}
