...
$\mathbf{a}$ onto the line generated by $\mathbf{b}$. To this
end, we denote by $M$ the plane generated by $\mathbf{a}$ and
$\mathbf{b}$ and we consider an orthonormal basis
...
More generally $\langle \mathbf{a}, \mathbf{b} \rangle$ 
is the component of $\mathbf{a}$ in the $\mathbf{b}$ 
direction.
\end{definition}
