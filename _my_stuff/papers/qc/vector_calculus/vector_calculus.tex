...
%
%
\section{Introduction: Vector Spaces}
...
\item $\mathbb{Z}_{p}$, the field of integers mod $p$, where $p$ is a prime number.
\end{itemize}
\end{definition}
...
\bigskip
\begin{figure}[H]
\center{\includegraphics[cfbox=red,scale=0.35] 
...
&=& \langle \mathbf{b}, \mathbf{a} \rangle
					&\qquad \mathrel{\#} \text{Equation (\ref{eqn:dot_product})} \\
[15pt]
&=& \langle \mathbf{b}, (\alpha \mathbf{v}_1 + \beta \mathbf{v}_2) \rangle
					&\qquad \mathrel{\#} \text{Equation (\ref{eqn:alpha_beta})} \\
[15pt]
...
\bigskip
\begin{figure}[H]
\center{\includegraphics[cfbox=red,scale=0.15] {images/right_hand_rule_cross_product.png}}
...
\bigskip
\begin{figure}[H]
\center{\includegraphics[cfbox=red,scale=0.40] {images/delta-r.png}}
...
\bigskip
\begin{figure}[H]
\center{\includegraphics[cfbox=red,scale=0.45]
