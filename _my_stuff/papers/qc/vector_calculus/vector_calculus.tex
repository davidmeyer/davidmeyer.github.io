...
neither is. So without loss of generality let 
${\displaystyle \mathbf{x} = \frac{\mathbf{a}}{\|\mathbf{a}\|}}$ and 
${\displaystyle \mathbf{y} = \frac{\mathbf{b}}{\|\mathbf{b}\|}}$ and so
$\| \mathbf{x} \| = \|\mathbf{y} \| = 1$ ($\mathbf{x} 
= \mathbf{\hat{a}}$ and $\mathbf{y} = \mathbf{\hat{b}}$). 
...
\bigskip
\noindent
Combining these expressions for $\| \mathbf{x} \| - \| \mathbf{y} \|$
gives us the reverse triangle inequality (Equation 
(\ref{eqn:reverse_triangle_inequality})):
...
\bigskip
\noindent
To see how the reverse triangle inequality and our
definitions of $\mathbf{x}$ and $\mathbf{y}$ imply 
the Cauchy–Schwarz inequality consider that
...
and $c_2 = 1$ we have $\langle -\mathbf{a},\mathbf{b} \rangle 
