...
denotes a unit vector. A unit vector $\hat{\mathbf{u}}$ is 
defined to be 
...
definitions the parametric form of some $C$ in 
$\mathbb{R}^3$, $\mathbf{r}(t)$, would be
...
\bigskip
\noindent
where $g(t)$, $h(t)$ and $k(t)$ are scalar 
functions and $\mathbf{\hat{i}}$, $\mathbf{\hat{j}}$ and  
