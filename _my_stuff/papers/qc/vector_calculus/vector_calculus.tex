...
variables $x$ and $y$ are substituted for new variables $u$ and $v$ through two functions:
...
\bigskip
\noindent
In this case the Jacobian is defined as the determinant of the $2 \times 2$ matrix:
...
\begin{figure}[H]
\center{\includegraphics[cfbox=black,scale=0.40] {images/r_theta_to_x_y.png}}
...
\bigskip
\noindent
This situation shown in Figure \ref{fig:type_I_region}.

\bigskip
\begin{figure}[H]
\center{\includegraphics[cfbox=black,scale=0.30] {images/type_I_region.png}}
...
\bigskip
\noindent
This situation depicted in Figure \ref{fig:type_II_region}.

\bigskip
\begin{figure}[H]
\center{\includegraphics[cfbox=black,scale=0.30] {images/type_II_region.png}}
...
%	draw axes
%
     \draw[thick, -latex] (O) -- (Xend) coordinate [label={[right] $x$}];  											% x axis
     \draw[thick, -latex] (O) -- (Yend) coordinate [label={[above] $y$}];  										% y axis
%
%	draw parallelogram
%
