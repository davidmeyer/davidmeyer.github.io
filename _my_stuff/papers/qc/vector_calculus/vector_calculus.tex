...
$\mathbb{R}^3$ and that $M$ is the plane generated by them. Then these 
...
\bigskip
\noindent
This geometric interpretation is depicted in Figure 
\ref{fig:geometric_dot_product}.
...
\begin{figure}[H]
  \centering
  \resizebox{0.53 \textwidth}{!} {                              % resize figure if you want
