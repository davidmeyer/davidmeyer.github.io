...
\begin{figure}[t]
\center{\includegraphics[scale=1.0] {images/r_theta_to_x_y.jpg}}
...
[20pt]
&=& -10
			&\mathrel{\#} \text{\small the region is completely below the $u$ axis} \\
[10pt]
...
\smallskip
\begin{itemize}
\item [] (FA0) For any $a,b \in \mathbb{K}$ there is a unique element $a+b \in \mathbb{K}$.
\item [] (FA1) For all $a,b,c \in \mathbb{K}$ we have $a+(b+c) = (a+b)+c$.
\item [] (FA2) There is an element $0 \in \mathbb{K}$ such that $a+0= 0+a = a$ for all  $a \in \mathbb{K}$.
\item [] (FA3) For any $a \in \mathbb{K}$ there exists $-a \in \mathbb{K}$ such that $a+(-a) = (-a)+a = 0$.
\item [] (FA4) For any $a,b \in \mathbb{K}$ we have $a+b = b+a$.
\end{itemize}
...
\smallskip
\begin{itemize}
\item [] (FM0) For any $a, b \in \mathbb{K}$, there is a unique element $ab \in \mathbb{K}$.
\item [] (FM1) Forall $a,b,c \in \mathbb{K}$ we have a $(bc)=(ab)c$.
\item [] (FM2) There is an element $1 \in \mathbb{K}$, $1 \ne 0$ from (FA2),
               such that $a1 = 1a = a$ for all $a \in \mathbb{K}$.
\item [] (FM3) For any $a \in \mathbb{K}$ with $a \ne 0$, there exists $a^{-1} \in \mathbb{K}$
               such that $aa^{-1} = a^{-1}a = 1$.
\item [] (FM4) For any $a,b \in \mathbb{K}$ we have $ab=ba$.
\end{itemize}
...
\smallskip
\begin{itemize}
\item [] (D) For all $a,b,c \in \mathbb{K}$, we have $a(b+c) = ab+ac$.
\end{itemize}
...
characteristic, which is defined as follows:
the characteristic of a field $\mathbb{K}$, often denoted $\text{char} (\mathbb{K})$, 
is the smallest number of times one must use the field's (or ring's) multiplicative 
identity (1) in a sum to get the additive identity (0). If this sum never reaches 
the additive identity the field is said to have characteristic zero.
That is, 
