...
\bigskip
\noindent
where $\| \mathbf{u} \|$ is the Euclidean Norm
...
\bigskip
\begin{equation*}
\| \mathbf{x} - \mathbf{y} \|^2 = \| \mathbf{x} \|^2 + \| \mathbf{y}\|^2 - 2 \|
...
&=& \langle \mathbf{x} - \mathbf{y}, \mathbf{x} - \mathbf{y} \rangle
 		&\hspace{2em} \mathrel{\#} \text{${\| \mathbf{x} \|}^2 = \langle \mathbf{x},\mathbf{x} \rangle$
					(Equation (\ref{eqn:magnitude}))} \\
[8pt]
&=& \sum\limits_{j = 1}^{n} (x_j - y_j)^2
		&\hspace{2em} \mathrel{\#} \text{$\langle \mathbf{x},\mathbf{x} \rangle  = \sum\limits_{j = 
					1}^{n} {x}^{2}_{j}$ (Equation (\ref{eqn:magnitude}))}\\
[12pt]
&=& \sum\limits_{j = 1}^{n} \left [ x_{i}^{2} - 2 x_{j} y _{j} + y_{j}^{2} \right ]
		&\hspace{2em} \mathrel{\#} \text{expand previous line} \\
[12pt]
...
&=&  \| \mathbf{x} \|^2 - 2  \langle \mathbf{x} , \mathbf{y} \rangle + \| \mathbf{y} \|^2 
 		&\hspace{2em} \mathrel{\#} \text{${\| \mathbf{x} \|}^2 = \sum\limits_{j = 1}^{n} {x}^{2}_{j}$ 
					and $\langle \mathbf{x},\mathbf{y} \rangle  = \sum\limits_{j =  1}^{n} x_{j} y_{j}$ (Equations (\ref{eqn:magnitude}) and (\ref{eqn:dot}))} \\
[13pt]
&=&  \| \mathbf{x} \|^2 + \| \mathbf{y} \|^2 - 2  \langle \mathbf{x} , \mathbf{y} \rangle
 		&\hspace{2em} \mathrel{\#} \text{rearrange: $\| \mathbf{x} - \mathbf{y} \|^2 = \| \mathbf{x} \|^2 +
					\| \mathbf{y} \|^2 - 2  \langle \mathbf{x} , \mathbf{y} \rangle$}
\end{array}
\end{equation*}
...
\langle \mathbf{x}, \mathbf{y} \rangle 
&=& \| \mathbf{x} \| \| \mathbf{y} \| \cos \theta
		&\qquad \qquad \mathrel{\#} \text{Equation (\ref{eqn:cos_identity})} \\
[10pt]
...
&\leq& \| \mathbf{x} \|^2 - 2 \langle \mathbf{x},\mathbf{y} \rangle 
					+ \|\mathbf{y}\|^2
					&\mathrel{\#} \text{${\| \mathbf{x} \|}^2 = 
					\sum\limits_{j = 1}^{n} x_{j}^2$  and 
					$\langle \mathbf{x},\mathbf{y} \rangle  = \sum\limits_{j = 
					1}^{n} x_{j} y_{j}$ (Equations  (\ref{eqn:magnitude}) and (\ref{eqn:dot}) 
					respectively)} \\
[12pt]
&\leq& 1 - 2 \langle \mathbf{x},\mathbf{y} \rangle + 1
					&\mathrel{\#} \| \mathbf{x} \| = \|\mathbf{y} \| 
...
&\Rightarrow& \langle \mathbf{a},\mathbf{b} \rangle \leq \|\mathbf{a}\| \|\mathbf{b} \|
					&\mathrel{\#} \text{multiply both sides by $\|\mathbf{a}\| \|\mathbf{b}\|$}
...
\Rightarrow \big | \langle \mathbf{a},\mathbf{b} \rangle \big |  \leq \|\mathbf{a}\| 
