...
\bigskip
\noindent
Thanks also to Ben Reiniger(@bmreiniger@mathstodon.xyz) for pointing
out that in Figure 10 we care about whether the integrand is positive/negative 
over the region, but the region itself is just an area in the plane.
