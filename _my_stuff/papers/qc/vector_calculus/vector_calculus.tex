...
&\Rightarrow& {\displaystyle ds -\lim_{\Delta t \to 0} \Bigg  [ \bigg \| 			
			\dfrac{\mathbf{r}(t + \Delta t) - \mathbf{r}(t)}{\Delta t} \bigg \| \cdot \Delta t} \Bigg ] 
			= 0
			&\qquad \mathrel{\#} \text{sum rule for limits, 
			${\displaystyle \lim_{\Delta t \to 0} 0 = 0}$,
			${\displaystyle \lim_{\Delta s \to 0} \Delta s = ds}$} \\
[15 pt]
...
&=& \sqrt{dg^2 + dh^2} \cdot \dfrac{dt}{dt}
			&\qquad \qquad \mathrel{\#} \text{multiply by $1 = \dfrac{dt}{dt}$}  \\
[15pt]
&=& \sqrt{dg^2 + dh^2} \cdot \Bigg [ dt \cdot \sqrt{\dfrac{1}{dt^2}} \Bigg ]
			&\qquad \qquad \mathrel{\#} \dfrac{x}{x} = x \cdot \dfrac{1}{\sqrt{x^2}}  \\
[15pt]
...
&=& \sqrt{g^{\prime}(t)^2 + h^{\prime}(t)^2} \cdot dt		
			&\qquad \qquad \mathrel{\#} \text{switch notation and note that 		
			$\dfrac{d\mathbf{r}}{dt} = g^{\prime}(t) \, \hat{\mathbf{i}} + h^{\prime}(t) \, \hat{\mathbf{j}}$} \\
[15pt]
&=& \bigg \| \dfrac{d \mathbf{r}}{dt} \bigg \| \cdot dt
			&\qquad \qquad \mathrel{\#} \text{definition of $\mathbf{r}(t)$ and $\|\cdot\|$}
\end{array}
\end{equation*}
