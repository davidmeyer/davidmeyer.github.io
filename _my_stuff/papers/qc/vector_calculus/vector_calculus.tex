...
&\Rightarrow& - \Big [ \| \mathbf{y} \| - \| \mathbf{x} \| \Big ]\geq -\| \mathbf{y} - \mathbf{x}\|
					&\quad \mathrel{\#} \text{multiply both sides by -1: $- 1 * (\mathbf{a} \leq \mathbf{b}) 
					\Rightarrow -\mathbf{a} \geq -\mathbf{b}$} \\
[8pt]
...
&\Rightarrow& 0 \leq \langle \mathbf{x} - \mathbf{y}, \mathbf{x} - \mathbf{y} \rangle
					&\quad \mathrel{\#} \| \mathbf{a} \|^{2} = \langle \mathbf{a},\mathbf{a} \rangle
					\text{ by Equation (\ref{eqn:magnitude})} \\
[8pt]
...
&\Rightarrow& \dfrac{\langle \mathbf{a},\mathbf{b} \rangle}{\|\mathbf{a}\| \|\mathbf{b}\|} \leq 1
					...
					$\! \langle c_{1}\mathbf{a}, c_{2}\mathbf{b} \rangle 
					= c_{1} c_{2} \langle \mathbf{a}, \mathbf{b} \rangle$}}\\
[12pt]
