...
{1}{2^{s}} + \frac {1}{3^{s}} + \frac{1}{4^s} + \frac{1}{5^2} +
\cdots     
\label{equation1}  
\end{equation}
...
Equation \ref{equation1}, which gives us a new equation, Equation
\ref{equation3}. This new equation will serve as the input to the
next iteration. 
...
hand side of the input equation (Equation \ref{equation1}) which
have a factor of 2 in the denominator. These are the terms that are "sieved" in this
...
\ref{equation3} we  get a new equation, Equation \ref{equation5}: 
...
of Equation \ref{equation3} which have a factor of 3. The next
iteration will knock out all of the terms on the right hand side
that have a factor of 5, yielding
...
\cite{wiki:dirichlet_series}. $\square$
