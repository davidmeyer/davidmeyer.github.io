...
\large
\noindent
How can we find a nice expression (whatever that means) for $\pi^\pi$? 
The first thing we might do is to consider what $x^x$ (and so $\pi^\pi$) 
might mean. Well, in general $a^x$ is defined as $e^{x \ln a}$ for positive 
$a$ since 
