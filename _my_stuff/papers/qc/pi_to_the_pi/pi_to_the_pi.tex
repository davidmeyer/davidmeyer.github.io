...
know that $a^x = e^{x \ln a}$ for positive $a$ since
...
[10pt]
&\Rightarrow& e^{\ln y} = e^{x \ln a}			&\qquad \qquad \qquad \qquad \qquad \mathrel{\#} \text{$x = y \Rightarrow e^x = e^y$ (exponentiate both sides)} \\
[10pt]
