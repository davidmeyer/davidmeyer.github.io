...
\bigskip
\noindent
Going the other way, if $R$ has a cancellation law with $a \in R$ and
$a \neq 0$ then $a\cdot b=0=a\cdot 0 \Rightarrow b=0$ and so $a$ is 
not a zero divisor. That is, $R$ is an integral domain. $\blacksquare$
