...
\noindent
\textbf{Proof.} Suppose $R$ is an integral domain with $a,b,c \in R$, 
$a \neq 0$, and assume that $ab = bc$. Then 
...
\bigskip
\noindent
Thus $R$ being an integral domain implies that $R$ has a cancellation law.

\bigskip
\noindent
Going the other way, suppose $R$ has a cancellation law with $a,b \in R$, 
$a \neq 0$, and assume that $a\cdot b = 0$. Then
...
[5pt]
&\Rightarrow& b = 0 				
			&\hspace{2em} \mathrel{\#} \text{cancel $a \Rightarrow a$ is not a zero divisor and so 
...
\bigskip
\noindent
Thus $R$ having a cancellation law implies that $R$ is an integral 
domain. $\blacksquare$
