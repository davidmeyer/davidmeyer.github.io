...
\smallskip
\begin{lemma}
$R$ has a cancellation law if and only if $R$ is an integral domain.
...
(has no zero divisors) with $a,b,c \in R$ and $a \neq 0$, and assume
that $ab = bc$. Then 
...
[5pt]
&\Rightarrow& b = c 
			&\hspace{2em} \mathrel{\#} \text{$R$ has a cancellation law}
\end{array}
\end{equation*}

\bigskip
\noindent
Thus $R$ an integral domain implies that $R$ has a cancellation law.

\bigskip
\noindent
Going the other way, suppose $R$ has a cancellation law with $a,b \in R$ 
and assume that $a\cdot b = 0$. Then
...
[5pt]
&\Rightarrow& b = 0 				
			&\hspace{2em} \mathrel{\#} \text{cancel $a$ 
				($R$ has a cancellation law)}\\
\end{array}
\end{equation*}

\bigskip
\noindent
So $a$ is not a zero divisor. Thus $R$ having a cancellation law implies 
that $R$ is an integral domain. $\blacksquare$
