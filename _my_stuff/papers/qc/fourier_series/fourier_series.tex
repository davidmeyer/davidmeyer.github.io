...
Define the constant function $1(t) = 1$ for all $t$. I'm not sure
if there is standard notation for this but here I'll use 1 as
shorthand for $1(t)$.  In any event, now we can see some of the
similarities between linear algebra and Fourier series, a few of
which are summarized in Table \ref{table:vector_spaces}.
...
\noindent
 ...
 \sin nt\}, \, m,n \in \mathbb{N}\backslash\{0\}$ are pairwise
 orthogonal:
