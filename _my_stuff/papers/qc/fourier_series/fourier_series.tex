...
Define the constant function $\phi_{1}(x) = 1$. I'm not sure
if there is standard notation for this but here I'll use 1 to 
mean either the scalar 1 or $\phi_{1}(x)$ (I still have my 
concerns about the definitionof 1). In any event, now we can 
see some of the similarities between linear algebra and Fourier 
series, a few of which are summarized in Table \ref{table:vector_spaces}.
...
\begin{equation*}
	\langle 1,1 \rangle													= 
	\langle \phi_{1}(t), \phi_{1}(t) \rangle										= 
		\frac{1}{\pi}\int\limits_{-\pi}^{\pi} \phi_{1}(t) \cdot \phi_{1}(t) \, dt	= 
