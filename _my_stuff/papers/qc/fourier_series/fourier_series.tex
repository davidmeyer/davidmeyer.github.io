...
1$). However, for the Fourier series (where 1 represents the 
constant function $1 = f(t)$) we have $\langle 1,1 \rangle = 2$. 
Why? We can see this in Equation (\ref{table:vector_spaces}) 
