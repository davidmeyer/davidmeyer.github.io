...
if there is standard notation for this but here I'll use {\bf 1} as
shorthand for $\phi_{1}(x)$ (I still have my concerns about the definition
...
vectors $\hat{\mathbf{u}}$. However, $\langle {\bf 1},{\bf 1}
\rangle = 2$:
