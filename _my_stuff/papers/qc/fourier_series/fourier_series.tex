...
Define the constant function $1(x) = 1$. I'm not sure
if there is standard notation for this but here I'll use 1 as
shorthand for $1(x)$ (I still have my concerns about the definition
of 1). In any event, now we can see some of the similarities between 
linear algebra and Fourier series, a few of which are summarized 
in Table \ref{table:vector_spaces}.
