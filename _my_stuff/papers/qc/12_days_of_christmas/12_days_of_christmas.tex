...
triangular and tetrahedral numbers. So first, what
...
"tetrahedral number"). For example, $T_{e_{4}}$ is depicted 
in Figure \ref{fig:tetrahedral_numbers}. The $n^{\text{th}}$ 
...
\begin{figure}[H]
  ...
  \caption{The $4^{\text{th}}$ tetrahedral number $T_{e_{4}} = 20$}
