...
gift received on day {\bf n}.  The number of gifts received by
day {\bf n} is shown in red in Table
\ref{tab:12_days_of_christmas}.  These numbers are called the
tetrahedral numbers and are defined as follows:
...
\vspace{1.0em}
\begin{figure}[H]
  \center{\includegraphics[frame,scale=0.400]
...
depicted in Figure \ref{fig:tetrahedral_numbers}. The
$n^{\text{th}}$ tetrahedral number turns out to be the number of
gifts received up to and including day {\bf n} in "The 12 Days of
Christmas".

\vspace{2.5em}
\begin{figure}[H]
  \center{\includegraphics[frame,scale=0.255]
