...
\bigskip
\noindent
The only numbers that satisfy Equation 
...
{\bf Total number of gifts received by day n}. This is shown in 
Figure \ref{fig:lua_pascals_triangle}.  Similarly, the $3^{\text{rd}}$
