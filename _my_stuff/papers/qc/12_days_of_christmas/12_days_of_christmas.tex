...
coefficient\footnote{Aside: The great mathematician Carl Friedrich Gauss
...
triangular numbers we get a tetrahedron (hence the name). For
example, $T_{e_{4}}$ is depicted in Figure
\ref{fig:tetrahedral_numbers}. The $n^{\text{th}}$ tetrahedral
number turns out to be the number of gifts received up to and
including day {\bf n} in "The 12 Days of Christmas".

\vspace{2.5em}
\begin{figure}[H]
  \center{\includegraphics[frame,scale=0.30]
