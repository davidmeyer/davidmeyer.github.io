...
numbers are shown in red in
Table \ref{tab:12_days_of_christmas}. These numbers are known as
...
\noindent
A number can be both triangular and tetrahedral. 
These numbers satisfy the following equation:
...
\vspace{1.5em}
\noindent
The only numbers that do satisfy Equation 
...
\begin{figure}[H]
  ...
  \fbox {                                                                       % put a box around the figure
    \resizebox{0.96 \textwidth}{!} {                                            % resize the figure if you want
    \begin{mplibcode}                                                           %
