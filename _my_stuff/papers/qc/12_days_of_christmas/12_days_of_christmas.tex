...
"The 12 Days of Christmas" also has interesting
connections to Pascal's triangle
\cite{wiki:pascals_triangle}. Specifically, the $3^{\text{rd}}$
diagonal of Pascal's triangle, shown in blue in Figure
...
$4^{\text{th}}$ diagonal of Pascal's triangle, shown in red
...
triangular numbers we get a tetrahedron (hence the name "tetrahedral number"). For
