...
\cite{wiki:theodorus_of_cyrene}. Theodorus used the spiral to prove 
that all of the square roots of the non-square integers from 3 to 17 
are irrational \cite{wiki:spiral_of_theodorus}. Theodorus' original 
spiral stopped at $n = 17$, apparently because $\sqrt{17}$ is the
