...
prove that all of the non-square integers in the interval
$[3,17]$ are irrational
\cite{wiki:spiral_of_theodorus}. Theodorus' original spiral
stopped at $\sqrt{17}$, apparently because $\sqrt{17}$ is the
length of the hypotenuse of the last triangle in the spiral that
doesn't overlap; this is shown in Figure
\ref{fig:the_spiral_of_theodorus}.
...
%																				%
            ...
            \draw [\currentcolor] (w) -- (t) -- (z);                            % draw the right angle box
...
\smallskip
\bigskip
\def \numberoftriangles {17}													% how many triangles
