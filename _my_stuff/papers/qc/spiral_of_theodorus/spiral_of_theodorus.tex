...
who discovered the spiral \cite{wiki:theodorus_of_cyrene}. Theodorus 
used the spiral to prove that all of the square roots of the non-square 
integers from 3 to 17 are irrational \cite{wiki:spiral_of_theodorus}. 
Theodorus' original spiral stopped at $n = 16$, apparently because 
$\sqrt{16+1} = \sqrt{17}$ is the length of the hypotenuse of the 
last triangle in the spiral that doesn't overlap; this is shown 
in Figure \ref{fig:the_spiral_of_theodorus}.
