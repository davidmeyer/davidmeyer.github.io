...
(see Figure \ref{fig:triangle_inequality}).  Note that there are
important differences (which we will get to later) between
distance, as measured by a metric $d(x,y)$ and length, as
