...
nested radical in Equation (\ref{eqn:3}) equal?
...
\bigskip
\noindent
After waiting in vain for a few months, he solved it
himself. In these notes we look at Ramanujan’s solution 
to a more general form of this problem.
...
\section{Ramanjuan's Approach}
Ramanujan noted that for any non-negative real number x, 
we have

\begin{equation*}
\begin{array}{llll}
x + 1
&=& \sqrt{(x + 1)^2}							&\qquad \mathrel{\#} x = \sqrt{x^2} \\
[5pt]
&\Rightarrow& x + 1 = \sqrt{1 + 2x + x^2}		&\qquad \mathrel{\#} (x+1)^2 = x^2 + 2x + 1 \\
[5pt]
&\Rightarrow& x + 1 = \sqrt{1 + x(x + 2)}		&\qquad \mathrel{\#} x^2 + 2x + 1 = x(x+2) + 1
\end{array}
\end{equation*}

\bigskip
\noindent
Next, notice that $(x + 2)$ can again be written as $((x + 1) + 1)$,
giving
...
&=& \sqrt{1 + x((x+1)+1)}								
		&\mathrel{\#} x+2 = ((x+1)+1) \\
[5pt]
&\Rightarrow& x + 1 = \sqrt{1 + x\sqrt{((x+1)+1)^2}}	
		&\mathrel{\#} \sqrt{((x + 1) + 1)^2} = ((x+1) + 1) \\
[5pt]
&\Rightarrow& x + 1 = \sqrt{1 + x\sqrt{1 + x\sqrt{1+2(x+1) + (x+1)^2}}}	
		&\mathrel{\#} ((x+1)+1)^2 = 1 + 2(x+1) + (x+1)^2 \\
[5pt]
&\Rightarrow& x + 1 = \sqrt{1 + x\sqrt{1 + x\sqrt{1+(x+1)(x+3)}}}
		&\mathrel{\#} 2(x+1) + (x+1)^2 = x^2+4x+3 = (x+1)(x+3)
\end{array}
\end{equation*}

\bigskip
\noindent
Now we can write $(x+3)$ as $((x+2)+1)$ and so

\begin{equation*}
\begin{array}{llll}
x + 1
&=& \sqrt{1 + x \sqrt{1 + (x+1)((x+2)+ 1)}}								
		&\mathrel{\#} \text{ write $(x+3)$ as $((x+2)+1)$} \\
[10pt]
&\Rightarrow& x + 1 = \sqrt{1+x\sqrt{1+(x+1)\sqrt{((x+2)+1)^2}}}
		&\mathrel{\#} ((x+2)+1) = \sqrt{((x+2)+1)^2} \\
[10pt]
&\Rightarrow& x + 1 = \sqrt{1+x\sqrt{1+(x+1)\sqrt{1+2(x+2)+(x+2)^2}}}
		&\mathrel{\#} ((x+2)+1)^2 = 1+2(x+2)+(x+2)^2 \\
[10pt]
&\Rightarrow& x + 1 = \sqrt{1+x\sqrt{1+(x+1)\sqrt{1 + (x+2)(x+4)}}}
		&\mathrel{\#}  1+2(x+2)+(x+2)^2 = x^2 + 6x + 8 = (x + 2)(x + 4) \\
[10pt]
&\Rightarrow& x + 1 = \sqrt{1+x\sqrt{1+(x+1)\sqrt{1+(x+2)\sqrt{((x+3)+1)^2}}}}
		&\mathrel{\#} (x+4) = ((x+3)+1), \, y = \sqrt{y^2}
...
\begin{equation}
x + 1 = \sqrt{1+x\sqrt{1+(x+1)\sqrt{1+(x+2)\sqrt{1 + (x+3)\sqrt{\hdots}}}}}
\label{eqn:continued_fraction}
\end{equation}

\bigskip
\noindent
Now, setting $x = 2$ in Equation (\ref{eqn:continued_fraction}) we get
...
But now that we have the general formula, we can plug in other 
values, say $x = 124$. Then
