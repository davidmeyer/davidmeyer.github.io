...
x + 1
&=& \sqrt{(x + 1)^2}							
				&\qquad \qquad \qquad \mathrel{\#} \text{$z = \sqrt{z^2}$ where $z = x+1$} \\
[5pt]
&\Rightarrow& x + 1 = \sqrt{1 + 2x + x^2}		
				&\qquad \qquad \qquad \mathrel{\#} (x+1)^2 = x^2 + 2x + 1 \\
[5pt]
&\Rightarrow& x + 1 = \sqrt{1 + x(x + 2)}		
				&\qquad \qquad \qquad \mathrel{\#} x^2 + 2x + 1 = x(x+2) + 1
\end{array}
\end{equation*}
...
\bigskip
\noindent
Now we can see that the general form of the nested 
radical for $x+1$ is:
