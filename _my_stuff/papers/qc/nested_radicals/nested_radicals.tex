...
\begin{array}{llll}
x + 1
&=& \sqrt{(x + 1)^2}							&\qquad \qquad \qquad \mathrel{\#} \text{$z = \sqrt{z^2}$ where $z = x+1$} \\
[5pt]
...
&\Rightarrow& x + 1 = \sqrt{1 + x\sqrt{((x+1)+1)^2}}	
		&\mathrel{\#} (x+1)+1 = \sqrt{((x+1)+1)^2} \\
[10pt]
&\Rightarrow& x + 1 = \sqrt{1 + x\sqrt{1 + x\sqrt{1+2(x+1)+(x+1)^2}}}	
		&\mathrel{\#} ((x+1)+1)^2 = 1 + \underbrace{2(x+1)+(x+1)^2}_{x^2+4x+3} \\
[10pt]
&\Rightarrow& x + 1 = \sqrt{1 + x\sqrt{1 + x\sqrt{1+(x+1)(x+3)}}}
		&\mathrel{\#} x^2+4x+3 = (x+1)(x+3)
\end{array}
\end{equation*}
...
&\Rightarrow& x + 1 = \sqrt{1+x\sqrt{1+(x+1)\sqrt{1+2(x+2)+(x+2)^2}}}
		&\mathrel{\#} ((x+2)+1)^2 = 1 + \underbrace{2(x+2)+(x+2)^2}_{x^2 + 6x + 8} \\
[15pt]
...
\bigskip
\noindent
Now we can see the general form of the nested radical for $x+1$:
