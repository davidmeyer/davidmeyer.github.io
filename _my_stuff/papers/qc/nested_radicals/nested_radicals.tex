...
\begin{array}{llll}
x + 1
&=& \sqrt{(x + 1)^2}							&\qquad \qquad \qquad \mathrel{\#} x = \sqrt{x^2} \\
[5pt]
&\Rightarrow& x + 1 = \sqrt{1 + 2x + x^2}		&\qquad \qquad \qquad \mathrel{\#} (x+1)^2 = x^2 + 2x + 1 \\
[5pt]
&\Rightarrow& x + 1 = \sqrt{1 + x(x + 2)}		&\qquad \qquad \qquad \mathrel{\#} x^2 + 2x + 1 = x(x+2) + 1
\end{array}
\end{equation*}
...
But now that we have the general formula, so we can plug in any positive integer. 
For example $x = 124$:
