...
&=& \sqrt{(x + 1)^2}							
				&\qquad \qquad \qquad \qquad \qquad \qquad \qquad
				 \mathrel{\#} \text{$z = \sqrt{z^2}$ where $z = x+1$} \\
[5pt]
&=& \sqrt{1 + 2x + x^2}		
				&\qquad \qquad \qquad \qquad \qquad \qquad \qquad
				 \mathrel{\#} (x+1)^2 = x^2 + 2x + 1 \\
[5pt]
&=& \sqrt{1 + x(x + 2)}		
				&\qquad \qquad \qquad \qquad \qquad \qquad \qquad
				 \mathrel{\#} x^2 + 2x + 1 = x(x+2) + 1
\end{array}
\end{equation*}
...
x + 1
&=& \sqrt{1 + x((x+1)+1)}								
		&\qquad \qquad \qquad \mathrel{\#} (x+2) = (x+1)+1 \\
[10pt]
&=& \sqrt{1 + x\sqrt{((x+1)+1)^2}}	
		&\qquad \qquad \qquad \mathrel{\#} (x+1)+1 = \sqrt{((x+1)+1)^2} \\
[10pt]
&=& \sqrt{1 + x\sqrt{1 + x\sqrt{1+2(x+1)+(x+1)^2}}}	
		&\qquad \qquad \qquad \mathrel{\#} ((x+1)+1)^2 = 1 + 
		\underbrace{2(x+1)+(x+1)^2}_{x^2+4x+3} \\
[10pt]
&=& \sqrt{1 + x\sqrt{1 + x\sqrt{1+(x+1)(x+3)}}}
		&\qquad \qquad \qquad \mathrel{\#} x^2+4x+3 = (x+1)(x+3)
\end{array}
\end{equation*}
...
&=& \sqrt{1+x \sqrt{1+(x+1)((x+2)+1)}}								
		&\quad \quad \mathrel{\#} (x+3) = (x+2)+1 \\
[12pt]
&=& \sqrt{1+x\sqrt{1+(x+1)\sqrt{((x+2)+1)^2}}}
		&\quad \quad \mathrel{\#} (x+2)+1 = \sqrt{((x+2)+1)^2} \\
[15pt]
&=& \sqrt{1+x\sqrt{1+(x+1)\sqrt{1+2(x+2)+(x+2)^2}}}
		&\quad \quad \mathrel{\#} ((x+2)+1)^2 = 1 + 2(x+2)+(x+2)^2 \\
[15pt]
&=& \sqrt{1+x\sqrt{1+(x+1)\sqrt{1+x^2+6x+8}}}
		&\quad \quad \mathrel{\#} 2(x+2)+(x+2)^2 = x^2+6x+8 \\
[15pt]
&=& \sqrt{1+x\sqrt{1+(x+1)\sqrt{1 + (x+2)(x+4)}}}
		&\quad \quad \mathrel{\#} x^2+6x+8 = (x+2)(x+4) \\
[12pt]
&=& \sqrt{1+x\sqrt{1+(x+1)\sqrt{1+(x+2)\sqrt{((x+3)+1)^2}}}}
		&\quad \quad \mathrel{\#} (x+4) = (x+3)+1 = \sqrt{((x+3)+1)^2}
\end{array}
\end{equation*}
