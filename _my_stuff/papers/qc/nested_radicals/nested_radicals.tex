...
Ramanujan noted that for any non-negative integer $x$ 
we have
...
x + 1
&=& \sqrt{(x + 1)^2}							
				&\hspace{16em} \mathrel{\#} x + 1 = \sqrt{(x + 1)(x + 1)} =  \sqrt{(x + 1)^2} \\
[5pt]
&=& \sqrt{1 + 2x + x^2}		
				&\hspace{16em} \mathrel{\#} (x+1)^2 = x^2 + 2x + 1 \\
[5pt]
&=& \sqrt{1 + x(x + 2)}		
				&\hspace{16em} \mathrel{\#} x^2+2x+1 = x(x+2)+1
\end{array}
\end{equation*}
