...
[12pt]
&\Rightarrow& y^{\frac{1}{2}} = x^{\sum\limits_{j = 1}^{\infty} {(\frac{1}{3}})^j}
				&\qquad \qquad \mathrel{\#} \sum\limits_{j = 1}^{\infty} {(\frac{1}{3}})^{j}  = \frac{1}{3} + \frac{1}{9} + \frac{1}{27} + \frac{1}{81} + \cdots \\
[15pt]
&\Rightarrow& y^{\frac{1}{2}} = x^{\sum\limits_{j = 0}^{\infty} {(\frac{1}{3})}^j - 1}
				&\qquad \qquad \mathrel{\#}  \sum\limits_{j = 1}^{\infty} {(\frac{1}{3}})^j 
				=  \sum\limits_{j = 0}^{\infty} {(\frac{1}{3}})^j -  (\frac{1}{3})^0 
				= \sum\limits_{j = 0}^{\infty} {(\frac{1}{3}})^j - 1 \\
[15pt]
&\Rightarrow& y^{\frac{1}{2}} = x^{\frac{1}{1- \frac{1}{3}}  - 1}
				&\qquad \qquad \mathrel{\#} \text{geometric series:} \sum\limits_{j = 0}^{\infty}  ar^j  = \dfrac{a}{1-r} \text{ for }  0 < r < 1 \text{; here }  a = 1  \text{ and }  r = \frac{1}{3}  \\
[15pt]
