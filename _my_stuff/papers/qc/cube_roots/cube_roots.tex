...
&\Rightarrow& y^{\frac{1}{2}} = x^{\sum\limits_{j = 1}^{\infty} {(\frac{1}{3}})^j}
				&\qquad \qquad \mathrel{\#} \text{rewrite as a geometric series starting at $j = 1$; here $a = 1$ and $r = \frac{1}{3}$} \\
[12pt]
&\Rightarrow& y^{\frac{1}{2}} = x^{\sum\limits_{j = 0}^{\infty} {(\frac{1}{3})}^j - 1}
				&\qquad \qquad \mathrel{\#} \text{rewrite as a geometric series starting at $j = 0$} \\
[15pt]
&\Rightarrow& y^{\frac{1}{2}} = x^{\frac{1}{1- \frac{1}{3}} - 1}
				&\qquad \qquad \mathrel{\#} \sum\limits_{j = 0}^{\infty}  ar^j  - 1 = \dfrac{a}{1-r} - 1  \\
[15pt]
&\Rightarrow& y^{\frac{1}{2}} = x^{\frac{3}{2}- 1}
				&\qquad \qquad \mathrel{\#}  a = 1 \text{ and } r = \frac{1}{3} \Rightarrow \dfrac{1}{1 - \frac{1}{3}}  = \frac{3}{2} \\
[15pt]
