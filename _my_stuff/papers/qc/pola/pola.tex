...
\bigskip
\noindent
Also amazingly, the principle can be used to derive Newton's Second Law,  $F = ma$, Lagrangian and Hamiltonian equations of motion, and even 
...
$V(x) = m \cdot g \cdot x$ (note thathere $x$ is shorthand for $x(t)$). Then
