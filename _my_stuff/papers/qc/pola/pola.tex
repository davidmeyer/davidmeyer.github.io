...
and is also informally referred to as $PE$.}. In this case $V[x(t)] = m \cdot g \cdot x(t)$. Then
...
\bigskip
\noindent
So now if we substitute these last two expressions into Equation \ref{eqn:S(x)} and group terms we see that
