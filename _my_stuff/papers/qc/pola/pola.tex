...
Action states that the path for which the sum of these differences has the minimum sum is the actual path the particle will take. To study this problem
