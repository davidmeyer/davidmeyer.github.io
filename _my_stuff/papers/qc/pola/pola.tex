...
\bigskip
\noindent
To find the position of the mass $m$ as a function of time (call it $x(t)$) we need to solve the Euler–Lagrange equation (Equation \ref{eqn:euler-lagrange}) for this value of $L$. Recall that 
