...
Since the differentiation is a linear operation \cite{wiki:linearity_of_differentiation} and we know that 
...
\begin{equation*}
\dfrac{\partial L}{\partial \dot{x}} = \dfrac{\partial}{\partial \dot{x}} \Bigg [   \dfrac{1}{2} m \dot{x}^2 - \dfrac{1}{2} k x^2 \Bigg ]= \dfrac{1}{2} 2 m \dot{x} - 0 = m \dot{x}
\end{equation*}
