...
Consider the "ratio of our ages" sequence of the form
...
what does this sequence converge, and if it does, to what value? Well,
first, assume that $y_t + n \neq n$ for all $n \in \mathbb{N}$. Then take 
...
\bigskip
\noindent
Now,  we know that the limit operator is a linear operator \cite{fa_mit} so we see that
...
&=& \dfrac{{\displaystyle \lim_{n \to \infty} \left (x_t + n \right )}\left (\frac{1}{n}\right )} 
          {{\displaystyle \lim_{n \to \infty} \left (y_t + n \right)} \left ( \frac{1}{n} \right )}
			&\qquad \qquad \qquad \mathrel{\#} \text{multiply by $1 = \frac{\frac{1}{n}}{\frac{1}{n}}$}\\
[17pt]
