...
\medskip
\begin{equation*}
(a_n)_{n \in \mathbb{N}_{0}} = \left (\dfrac{x_t +n}{y_t + n}\right )_{n \in \mathbb{N}}
\end{equation*}
...
\bigskip
\noindent
That is, $(a_n)_{n \in \mathbb{N}_{)}}$ is a sequence of real numbers.
...
sequence $\left (\dfrac{x_t +n}{y_t + n}\right )_{n \in \mathbb{N}}$ 
