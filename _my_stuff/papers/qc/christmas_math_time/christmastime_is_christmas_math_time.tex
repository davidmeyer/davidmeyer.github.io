...
\section{Christmas Tree Coordinate Systems}
\vspace{1.25em}
\begin{figure} [H]
   \center{\includegraphics[frame, scale=0.40] {images/xmas-tree.jpeg}}
   \caption{Christmas Tree Coordinates Systems}
   \label{fig:christmas_tree_coordinates_systems}
\end{figure}
