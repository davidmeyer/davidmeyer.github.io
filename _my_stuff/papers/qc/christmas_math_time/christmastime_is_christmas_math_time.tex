...
geometric patterns in a rectangular grid \cite{hitomezashi_pattern}.


\bigskip
\begin{figure} [H]
  \center{\fcolorbox{red}{white}{\includegraphics[scale=0.45] {images/hitomezashi_christmas_tree.jpg}}}
