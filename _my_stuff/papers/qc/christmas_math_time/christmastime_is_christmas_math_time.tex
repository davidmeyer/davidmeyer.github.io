...
\bigskip
\begin{figure} [H]
\center{\includegraphics[frame, scale=0.28] {images/infinite_gift.jpg}}
...
(aka Torricelli’s Trumpet), which is shown in Figure
\ref{fig:gabriels_horn}.

\bigskip
\begin{figure} [H]
\center{\includegraphics[frame, scale=0.17] {images/gabriels_horn.jpg}}
...
still at primary school \cite{add_1_to_100}.}. For example,
...
if so there would have to exist $m,n \in \mathbb{Z}^{+}$ such
that
...
\cite{wiki:binomial_coefficient}. This (and the Christmas stocking) is shown in 
Figure \ref{fig:christmas_stocking_theorem}. 
\par}


\bigskip
\begin{figure} [H]
\center{\includegraphics[frame, scale=0.185] {images/christmas_stocking_theorem.jpg}}
...
Thanks to Alice Meyer for suggesting that I collect 
my "Christmastime is Christmas Math Time!" examples 
in one document.
%
