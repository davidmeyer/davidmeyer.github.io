...
{\setstretch{1.50}
\noindent
In this object the length of the side of the $n^{th}$ box is
$\frac{1}{\sqrt{n}}$, so that the area of a side of the $n^{th}$
box is ${\left ( \frac{1}{\sqrt{n}}\right ) }^2 = \frac{1}{n}$.
Thus the surface area of the $n^{th}$ box is $6 *
...
\infty$). These properties lead to an interesting situation 
...
still won't have enough paint to paint the surface of the 
inside of the horn (its area is infinite)!
