...
\mathcal{D}$ be functors from category $\mathcal{C}$ to category
$\mathcal{D}$. A natural transformation $\eta$ from $F$ to $G$ is
a family of morphisms in $D$, one for each object $A$ in
$\mathcal{C}$, such that
