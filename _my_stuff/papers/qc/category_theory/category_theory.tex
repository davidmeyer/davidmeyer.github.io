...
of composable morphisms between these objects.  Note here that we
say "collection of objects" to sidestep the following
...
\cite{russells_paradox}. As a result we use the idea of a
collection from ZF set theory \cite{zf_set_theory}.
...
for is used to indicate a specific category (for example, the category 
