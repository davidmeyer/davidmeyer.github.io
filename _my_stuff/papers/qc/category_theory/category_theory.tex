...
\newpage
\noindent
Here's a crazy (and beautiful) fact: A group $G$ is essentially
...
is exactly to say that every element of $\mathcal{C}(A,A)$ has 
...
\begin{center}
  \begin{table}[H]
    \begin{tabular}{l|r}
      ...
      $\circ \in \mathcal{C}(A,A)$                  & $\cdot \; \in G$ \\
      $1_{A} \in \mathcal{C}(A,A)$                  & $1 \in G$    \\
      \hline \hline
    \end{tabular}
   \end{table}
\end{center}
