...
to sidestep some set-theoretic issues, including: if instead 
"the set of objects" was used then in the category of sets 
the set of objects would we be the set of all sets, which 
we know by Russell's Paradox does not exist \cite{russells_paradox}. 
As a result the vague word "collection" might be interpreted 
as meaning "class" in the ZF set theory sense \cite{zf_set_theory}. 
