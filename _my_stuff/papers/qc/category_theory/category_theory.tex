...
\begin{itemize}
  \item the object $A$ 
  \item the  class of morphisms  $\mathcal{C}(A,A)$
  \item an associative composition function $\circ:
        \mathcal{C}(A,A) \times \mathcal{C}(A,A) \to
        \mathcal{C}(A,A)$  
  \item a two-sided unit $1_{A} \in \mathcal{C}(A,A)$
\end{itemize}
...
say that every map in $\mathcal{C}$ is an isomorphism is exactly
to say that every element of $\mathcal{C}(A,A)$ has an inverse
(with respect to $\circ$).

\bigskip
\noindent
So if $G$ is the group $\mathcal{C}(A,A)$, then we have:
...
\begin{center}
  \begin{table}[H]
    \begin{tabular}{l|r}
      ...
      Morphisms in $\mathcal{C}(A,A)$               & Elements of $G$ \\
