...
\bigskip
\noindent
Setting the Equation (\ref{eqn:hookes_law}) force equal
to the Equation (\ref{eqn:newtons_2nd_law}) force gives us
...
%	      
	      ...
	      \draw [draw=none] (12.00,2.00) -- (12.00,2.00) coordinate [label={[midway] \underline{{\bf  Set Forces Equal}}}];
