...
A conservative force is one for which work done by or against 
the force depends only on the starting and ending points of a 
motion and not on the path taken \cite{wiki:potential_energy}.
\end{definition}
