...
equilibrium. Hooke's Law is most frequently stated as\footnote{It
seems to be convention to use $x$ when $x$ is a scalar and
$\mathbf{x}$ for $x$ when it is a vector (same for functions)
in physics.} $F \propto -x$. That is, the force $F$ is
