...
\begin{array}{llll}
0
&=& L \ddot{I} + \bigg (\dfrac{1}{C} \bigg ) I							&\qquad \qquad \qquad \mathrel{\#} \text{Equation \ref{eqn:V}} \\
[12pt]
...
[12pt]
&\Rightarrow& \dfrac{d^2 I}{dt^2} = - \bigg (\dfrac{1}{LC} \bigg ) I	&\qquad \qquad \qquad \mathrel{\#} \ddot{I} = \dfrac{d^2 I}{dt^2}	\\	
[12pt]		
&\Rightarrow& \dfrac{d^2 I}{dt^2} = - \omega_{0}^{2} I					&\qquad \qquad \qquad \mathrel{\#} \text{set $\omega_{0} = \sqrt{\dfrac{1}{LC}}$}
\end{array}
\end{equation*}
