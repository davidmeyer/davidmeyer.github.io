...
from the equilibrium point (see Figure \ref{fig:spring_and_mass_system}). 
The law is named after 17th-century British physicist Robert Hooke
\cite{robert_hooke}. Hooke first stated the law in 1676 as a Latin
anagram, and he published the solution of his anagram in 1678 as:
ut tensio, sic vis ("as the extension, so the force" or "the
extension is proportional to the force") \cite{hooke_of_spring}.
...
\bigskip
\noindent
Now, balancing the Equation (\ref{eqn:hookes_law}) force with the
Equation (\ref{eqn:newtons_2nd_law}) force gives us
