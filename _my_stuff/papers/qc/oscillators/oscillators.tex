...
Amazingly, it turns out that the equation of motion for the LC circuit,
shown in Figure \ref{fig:series_lc_circuit}, has the same form as the 
equations of motion for both spring and mass and the small-angle pendulum 
systems, \cite{differential_equations_rlc_circuits,rlc_circuits}, namely
...
between a RLC circuit and a dampened spring and mass 
system? The answer is that they are both dampened 
