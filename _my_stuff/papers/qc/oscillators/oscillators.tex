...
that represents the damping. We can see that 
...
\bigskip
\noindent
The dynamics of the critically damped harmonic oscillator
 \cite{critically_damped_harmonic_oscillator} is shown in
Figure \ref{fig:critically_damped_harmonic_oscillator}.

\bigskip
\begin{figure}[H]
  \center{\includegraphics[scale=0.42,cfbox=black] {images/damped_harmonic_oscillator.png}}
...
\bigskip
\noindent
Finally, a few analogies between mechanical
and electrical systems is shown in Table \ref{tab:analogies}.
