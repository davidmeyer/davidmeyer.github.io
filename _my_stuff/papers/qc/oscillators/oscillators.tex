...
\bigskip
\noindent
So nowe we know that $\theta_1 = C_1 e^{i \omega t}$ is a
...
{\setstretch{1.75}
\noindent
where $A, B \in \mathbb{R}$ are constants defining the initial
conditions of the pendulum. Since $\theta$ is a linear
...
know that the period of a pendulum, after recalling that we
