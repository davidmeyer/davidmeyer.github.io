...
&=& m\dot{x}(t)\ddot{x}(t) + \dfrac{d}{dt} V(u)
		&\hspace{1em} \mathrel{\#} \text{let $u := x(t) \Rightarrow \dfrac{du}{dx} = 1$} \\
[12pt]
...
&=& m\dot{x}(t)\ddot{x}(t) + \left [ \dfrac{d}{dx}V(u) \right ] \dot{x}(t)
		&\hspace{1em} \mathrel{\#} \text{by the chain rule: $\dfrac{dV}{dx} = \dfrac{dV}{du} \dfrac{du}{dx}$ 
										 and  
										 $\dfrac{du}{dx} = 1
										 \Rightarrow
...
&=& m\dot{x}(t)\ddot{x}(t) + \left [ \dfrac{d}{dx}V(x(t)) \right ] \dot{x}(t)
		&\hspace{1em} \mathrel{\#} \text{since $u := x(t)$} \\
[12pt]
