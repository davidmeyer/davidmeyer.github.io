...
%
        ...
        \begin{footnotesize}
	      ...
	      \draw [draw=none] (12.00,0.40) -- (12.00,0.40) node[thin,draw,rectangle,midway] 
                                {${\; \mathbf {\dfrac{d^2 x}{dt^2} = -\dfrac{k}{m} x\;}}$};			 
	      \draw [draw=none] (12.00,-0.50) -- (12.00,-0.50) node[thin,draw,rectangle,midway] 
                                {${\; \mathbf {x(t) = A \,{\boldsymbol\cos} \, ({\boldsymbol \omega} t)\;}}$};
      	 \draw [draw=none] (12.00,-1.40) -- (12.00,-1.40) node[thin,draw,rectangle,midway] 
