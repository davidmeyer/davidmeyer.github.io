...
$x(t)$ conforming to Newton’s Second Law, the system's total energy 
...
{\setstretch{1.50}
\noindent
{\bf Proof.} One way to see Theorem \ref{theorem:conservation_of_energy_in_R1}
is to show that the system's total energy does not change with time, 
