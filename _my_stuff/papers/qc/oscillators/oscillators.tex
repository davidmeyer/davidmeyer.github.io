...
graph of $F$ vs. $x$ where the line has slope $k$. In this case
the area under the curve is $\frac{1}{2} kx^2$ and thus the
work done or potential energy stored is $\frac{1}{2} kx^2$.
\par}
