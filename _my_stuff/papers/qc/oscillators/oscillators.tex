...
&=& \dot{x}(t) \cdot \Big [m \ddot{x}(t) - F(x(t)) \Big ]
		&\hspace{2em} \mathrel{\#} \text{since $\dfrac{d}{dx}V(x(t)) = - F(x(t))$ 
		                                 (Equation (\ref{eqn:F}))} \\
[15pt]
&=& \dot{x}(t) \cdot 0
		&\hspace{2em} \mathrel{\#} \text{by Newton's $2^{\text{nd}}$ Law: 
		                                 $F = m\ddot{x} \Rightarrow m\ddot{x} - F = 0$} \\
[15pt]
&=& 0
		&\hspace{2em} \mathrel{\#} \dfrac{d}{dt} E(x(t),\dot{x}(t)) = 0 
\end{array}
\end{equation*}
