...
We can see that Equation \ref{eqn:damped_spring_and_mass} 
has the same form as Equation \ref{eqn:damp_general_form}.
\par }

\bigskip
\noindent
The dynamics of the damped harmonic oscillator
are graphed in Figure \ref{fig:critically_damped_harmonic_oscillator}.
A damped harmonic oscillator is said to be critically damped
if it's trajectory behaves like the red line if Figure
\ref{fig:critically_damped_harmonic_oscillator}. If the 
trajectory is above the upper blue curve the oscillator
is said to be overdamped. If the trajectory is below the
lower blue curve the oscillator said to be
underdamped \cite{critically_damped_harmonic_oscillator}.
...
\begin{figure}[H]
  ...
  \caption{Critically Damped Harmonic Oscillator \cite{damped_harmonic_oscillator}}
...
\begin{table} [H]
  ...
  \renewcommand{\arraystretch}{2.0}
     \resizebox{0.77 \textwidth}{!} {																	% resize figure if you want
