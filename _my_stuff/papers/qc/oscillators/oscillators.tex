...
&=& \dfrac{d}{dt} \bigg [\dfrac{1}{2}m(\dot{x}(t))^{2} + V(x(t)) \bigg ]	
		&\hspace{0em} \mathrel{\#} \text{Equation (\ref{eqn:E}) with $x = x(t)$ 
		                                 and $v = \dot{x}(t)$} \\	
[12pt]
...
&=& m\dot{x}(t)\ddot{x}(t) + \dfrac{d}{dt} V(x(t))
		&\hspace{0em} \mathrel{\#} \text{by the chain \& power rules \cite{wiki:chain_rule,wiki:power_rule}:
...
&=& m\dot{x}(t)\ddot{x}(t) + \left [\dfrac{d}{du}  V(u) \right ] \dot{x}(t)
		&\hspace{0em} \mathrel{\#} \text{by the chain rule: 
								         $\dfrac{dV}{dt} = 
...
&=& m\dot{x}(t)\ddot{x}(t) + \left [ \dfrac{d}{dx}V(u) \right ] \dot{x}(t)
		&\hspace{0em} \mathrel{\#} \text{by the chain rule: $\dfrac{dV}{dx} = 
...
[12pt]
&=& 0
		&\hspace{0em} \mathrel{\#} \text{since $m \ddot{x}(t) - F(x(t)) = 0$ 
