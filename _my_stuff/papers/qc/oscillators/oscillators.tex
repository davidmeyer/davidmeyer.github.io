...
frequently stated as $F \propto -x$, that is, the force $F$ is
...
use of a spring constant $k$ so that we have\footnote{It seems 
to be convention to use $x$ and $x(t)$ and $a$ and $a(t)$
interchangeably.}
...
\bigskip
\noindent
Balancing the Equation (\ref{eqn:hookes_law}) force with the
