...
[18pt]
		&=& {\displaystyle \int\limits_{0}^{1} x^{\left [ \left ( \sum\limits_{n=0}^{\infty} \frac{1}{n!} \right ) 
											\, - \, 1 \right ]} \; dx}
			&\hspace{0em} \mathrel{\#} \sum\limits_{n=1}^{\infty} \frac{1}{n!} = 
...
[18pt]
		&=& {\displaystyle \int\limits_{0}^{1} x^{e-1}} \; dx
			&\hspace{0em} \mathrel{\#}  \sum\limits _{n=0}^{\infty} \frac{1}{n!} = e  
...
[18pt]
		&=& \dfrac{x^{e}}{e} \bigg |_{0}^{1}
			&\hspace{0em} \mathrel{\#} (e - 1) + 1 = e \\
[18pt]
		&=& \dfrac{1^{e}}{e} - \dfrac{0^{e}}{e}
			&\hspace{0em} \mathrel{\#} \text{evaluate at the endpoints} \\
[18pt]
		&=& \dfrac{1}{e} - \dfrac{0}{e}
			&\hspace{0em} \mathrel{\#} 1^e = 1 \text{ and } 0^e = 0 \\
[12pt]
		&=& \dfrac{1}{e}
			&\hspace{0em} \mathrel{\#} {\displaystyle \int\limits_{0}^{1} x \cdot 
