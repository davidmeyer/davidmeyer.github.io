...
[18pt]
		&=& {\displaystyle \int\limits_{0}^{1} x^{\left [ \frac{1}{1} + \frac{1}{1 \cdot 2} + 
	   		\frac{1}{1 \cdot 2 \cdot 3} + \frac{1}{1 \cdot 2 \cdot 3 \cdot 4} + 
			\frac{1}{1 \cdot 2\cdot 3 \cdot 4 \cdot5} + \cdots \right ]}} \; dx
...
[18pt]
		&=& {\displaystyle \int\limits_{0}^{1} x^{e-1}} \; dx
			&\hspace{0.250em} \mathrel{\#}  \sum\limits _{n=0}^{\infty} \frac{1}{n!} = e  
