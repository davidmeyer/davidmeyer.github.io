...
\smallskip
\noindent
for $|r| < 1$. If we then substitute $a = x$ and $r = x$ into Equation (\ref{equation:geometric_series_closed_form}) we get:
...
Thanks again to ohn Carlos Baez (@johncarlosbaez@mathstodon.xyz)
