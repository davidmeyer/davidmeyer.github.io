...
[12pt]
&=& \dfrac{a}{b-a} 							&\hspace{5em} \mathrel{\#} \text{cancel $b$} \\ 
\end{array}
\end{equation*}

\medskip
\noindent
So we see that if $x = \frac{a}{b}$ then $S = \dfrac{a}{b-a}$, for $a < b$. This
is the result that we saw in Section \ref{section:what_does_S_converge_to}.
