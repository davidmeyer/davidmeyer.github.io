...
[5pt]
&\Rightarrow& r^{k-2} = r^{l -2}                        &\quad \qquad \mathrel{\#} \text{cancel $r$ (Equation (\ref{eqn:cancellation_law}))} \\
...
[5pt]
&\Rightarrow& r^{k-l} = r^{0}                           &\quad \qquad \mathrel{\#} \text{cancel $r$ (Equation (\ref{eqn:cancellation_law}))} \\ 
[5pt]
