...
%	A few parameters
%
\setlength			{\fboxsep} {0.25em}						% space between fcolorbox and content
\setlength			{\fboxrule}{0.25pt}						% fcolorbox line thickness
\def \scalefactor	{0.85}									% resizebox scale factor
...
one-dimensional subspace of "rays" \cite{wolfram:ray}. This is
