...
%
        ...
        \draw[-stealth, thick] (Gy0) -- (Gy1) coordinate [label={[font=\footnotesize, midway, right] $\vec{F}_{g}$}];	% draw the gravity vector (g)
...
This scenario is depicted in Figure \ref{fig:pythagorean_theorem}.
\par}
