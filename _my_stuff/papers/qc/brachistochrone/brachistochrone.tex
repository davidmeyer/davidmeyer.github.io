...
\begin{figure}[H]
  ...
  \resizebox{0.65 \textwidth}{!} {                                                                                                                       % resize the figure if you want
   \simplebox {                                                                                                                                                  % put a frame around the tikzpicture
     \begin{tikzpicture}                                                                                                                                       % draw the picture
%
...
%
       ...
       \node[circle, draw=black, fill=red, scale=0.75] at (Ball)  {};                                                                       % draw a red ball with a black outline on the curve 
