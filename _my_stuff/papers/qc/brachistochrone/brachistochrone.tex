...
the Pythagorean Theorem. This is shown in Figure 
\ref{fig:pythagorean_theorem}). Note that this approach 
requires that we treat $\dfrac{dy}{dx}$ as a fraction 
and as mentioned above, care needs to be taken when doing 
this. That said, as we saw above \par}
...
\bigskip
\begin{equation*}
I[y(t)] \,\, {\stackrel {\text{def}}{=}} \,\, \int_{x_1}^{x_2} ds = \int_{x_1}^{x_2} \sqrt{1 + (y^{\prime})^2} \; dx
\end{equation*}	
...
the just potential energy $mgy$. So here $I[y(t)]$ is
...
here $I[y(t)]$ is the integral of the Lagrangian:


\bigskip
\begin{equation*}
I[y(t)] \,\, {\stackrel {\text{def}}{=}} \,\, \int_{t_1}^{t_2} L(y(t),y(t)^{\prime}) \; dt
\end{equation*}
...
\bigskip
\noindent
where $T$ is the system's kinetic energy and $V$ 
