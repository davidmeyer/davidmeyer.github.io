...
\bigskip
\noindent
Recall that the Calculus of Variations is about finding a function that minimizes some other function. That 
"other function", which takes a function as an argument, is called a functional. Here $I[y]$ is the functional 
the function that is trying to be minimized, $L(y,y^{\prime})$, is
...
[15pt]
&=& C_1 \mathlarger{\mathlarger{\mathlarger{\int}}} 1 \; d\theta - 
