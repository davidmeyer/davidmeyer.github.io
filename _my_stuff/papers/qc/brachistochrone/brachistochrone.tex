...
The Brachistochrone problem, posed by Johann Bernoulli in June of 1696 \cite{brachistochrone_problem}, 
asks the following question:

\bigskip 
\begin{addmargin}[3em]{7em}										% 3em left, 7em right
Given two points A and B in a vertical plane\footnote{We label $\text{A} = (x_1,y_1)$ and $\text{B} = (x_2,y_2)$.}, 
what is the curve traced out by a point acted on only by gravity, which starts at A and reaches B in the 
shortest time? 
\end{addmargin}

\bigskip
\noindent
The scenario Bernoulli envisioned is shown in Figure \ref{fig:brachistochrone}.
