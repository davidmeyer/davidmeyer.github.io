...
\bigskip
\noindent
If we set $C_1 = 2 a$, $C_2 = 0$, and $\theta = \dfrac{\phi}{2}$ in 
Equations \ref{eqn:cycloid_x} and \ref{eqn:cycloid_y} we see that
...
\bigskip
\noindent
So Equations \ref{eqn:cycloid_x} and \ref{eqn:cycloid_y} turn out the be 
the equations for a cycloid (as we saw in Figures \ref{fig:cycloid} and 
\ref{fig:cycloid1}) and hence the "shortest time curve" (that is, the 
solution to the Brachistochrone problem) is a cycloid.
