...
maximizes or minimizes the integral $I[y(x)]$ (Equation \ref{eqn:I[y]}), subject to the boundary conditions 
$y(a) = A$ and $y(b) = B$. The integral $I[y(x)]$ is an example of a \emph{functional}, which (more generally) 
...
is a functional (rather than a function) and we frequently see $y(t)$ abbreviated as $y$ and $I[y(x)]$ 
as $I[y]$ (or just $I$). 
...
$A$ to $B$. In the language of the calculus of variations \cite{wiki:cov} the 
