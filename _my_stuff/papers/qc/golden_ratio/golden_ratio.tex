...
[6pt]
&\Rightarrow& x^2 + 2x\sqrt{x^2+1} + 1 + x^2 = c^2 
...
then $c = x + \sqrt{x^2+1} = \frac{1}{2} + \sqrt{\frac{5}{4}} = \frac{1 + \sqrt{5}}{2} = \phi$.
Alternatively, we see that $c = \phi$ when the upper limit of integration in
Equation (\ref{eqn:integral_equals_ln_c}) equals $\frac{1}{2}$, since
...
\dfrac{c^2 -1}{2c}
&=& \dfrac{1}{2}			
				&\hspace{1em} \mathrel{\#} \text{set the upper limit of integration $\left ( \frac{c^2 -1}{2c} \right )$ to $\frac{1}{2}$} \\
[8pt]
