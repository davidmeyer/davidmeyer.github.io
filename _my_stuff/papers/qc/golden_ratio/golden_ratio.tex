...
\title{An Interesting Integral Involving The Golden Ratio}
...
\bigskip
\noindent
To see why Equation (\ref{eqn:lnphi}) holds, first parameterize with 
$x = \tan y$ and $\sqrt{x^{2}+1} = \sec y$. So $dx = \sec^2 y \: dy$, 
$y = \arctan x$ and $\sec y = \sec (\arctan x) = \sqrt{x^{2}+1}$.
Now we can see that
...
[12pt]
&=& \ln \phi
		&\: \mathrel{\#} {\displaystyle \phi =  \frac{1 + \sqrt{5}}{2}}
\end{array}
\end{equation*}
%
%	get a bibliography
