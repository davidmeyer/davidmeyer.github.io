...
\, \mathbb{R}, \, \mathbb{C}$, prime, $\hdots$ [@paulmasson@mathstodon.xyz].

\bigskip
\noindent
Now, if we take $x = \frac{1}{2}$ (like in Equation (\ref{eqn:lnphi})) 
we see that $c = \phi$, since:
...
&\Rightarrow& c^2 -c -1 = 0		
				&\hspace{1em} \mathrel{\#} \text{$x^2-x-1$ is the golden 
								ratio's minimal polynomial \cite{wiki:golden_ratio}} \\
[8pt]
