...
\bigskip
\noindent
Then the golden ratio is just a particular choice of the upper 
endpoint of the integral, in particular, $\frac{1}{2}$. More 
specifically:

\begin{equation*}
\begin{array}{llll} 
{\displaystyle \int_{0}^{\frac{1}{2}} \dfrac{1}{\sqrt{x^{2} + 1}} \;  dx} 
&=&	{\displaystyle \ln \left (x + \sqrt{x^{2} + 1} \right ) \bigg |_{0}^{\frac{1}{2}}}
		&\hspace{3 em} \mathrel{\#} \text{Equation (\ref{eqn:ihs}) and the FToC} \\
[12pt]
&=& {\displaystyle \ln \left ( \frac{1}{2} + \sqrt{\left (\frac{1}{2} \right )^{2} + 1} \right )} -
	{\displaystyle \ln \left ( 0 + \sqrt{0^{2} + 1} \right )}
		&\hspace{3 em} \mathrel{\#} \text{difference of endpoints (FToC)}\\
[12pt]
&=& {\displaystyle \ln \left ( \frac{1}{2} + \sqrt{\frac{5}{4}} \right )} -
	{\displaystyle \ln 1}
		&\hspace{3 em} \mathrel{\#} {\displaystyle  0 + \sqrt{0^{2} + 1} = \sqrt{1} = 1}\\
[12pt]
&=& {\displaystyle \ln \left ( \frac{1}{2} + \sqrt{\frac{5}{4}} \right )}
		&\hspace{3 em} \mathrel{\#} \ln 1 = 0\\
[12pt]
&=& {\displaystyle \ln \left ( \frac{1 + \sqrt{5}}{2} \right )}
		&\hspace{3 em} \mathrel{\#} {\displaystyle \frac{1}{2} + \sqrt{\frac{5}{4}} = \frac{1 + \sqrt{5}}{2}} \\
[12pt]
&=& {\displaystyle \ln \phi}
		&\hspace{3 em} \mathrel{\#} {\displaystyle \phi = \frac{1 + \sqrt{5}}{2}}
\end{array}
\end{equation*}
%
