...
\bigskip
\noindent
If we take $x = \frac{1}{2}$ 
then $c = x + \sqrt{1+x^2} = \frac{1}{2} + \sqrt{\frac{5}{4}} = \frac{1 + \sqrt{5}}{2} = \phi$.
Alternatively, we see that $c = \phi$ since:
...
&\Rightarrow& c^2 -c -1 = 0		
				&\hspace{1em} \mathrel{\#} \text{$x^2-x-1$ is $\phi$'s 
								minimal polynomial \cite{wiki:golden_ratio}} \\
[8pt]
