...
As we saw in Section \ref{sec:taylor_series} the Taylor series for a $n+1$ times differentiable function $f(x)$ is

\medskip
\begin{equation}
f(x) = \sum\limits _{k=0}^{\infty}{\frac {f^{(k)}(a)}{k!}}(x-a)^{k}
